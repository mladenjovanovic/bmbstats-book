...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{female\_analysis <{-}}\StringTok{ }\NormalTok{bmbstats}\OperatorTok{::}\KeywordTok{describe\_data}\NormalTok{(}
  \DataTypeTok{x =}\NormalTok{ height\_data}\OperatorTok{$}\NormalTok{Female,}
  ...
  \DataTypeTok{control =} \KeywordTok{model\_control}\NormalTok{(}
    \DataTypeTok{seed =} \DecValTok{1667}\NormalTok{,}
    \DataTypeTok{boot\_type =} \StringTok{"perc"}\NormalTok{,}
    \DataTypeTok{boot\_samples =} \DecValTok{1000}\NormalTok{,}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{female\_analysis\_my\_est <{-}}\StringTok{ }\NormalTok{bmbstats}\OperatorTok{::}\KeywordTok{describe\_data}\NormalTok{(}
  \DataTypeTok{x =}\NormalTok{ height\_data}\OperatorTok{$}\NormalTok{Female,}
  \DataTypeTok{estimator\_function =}\NormalTok{ my\_estimators,}
  \DataTypeTok{control =} \KeywordTok{model\_control}\NormalTok{(}
    \DataTypeTok{seed =} \DecValTok{1667}\NormalTok{,}
    \DataTypeTok{boot\_type =} \StringTok{"perc"}\NormalTok{,}
    \DataTypeTok{boot\_samples =} \DecValTok{1000}\NormalTok{,}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{female\_analysis\_extensive <{-}}\StringTok{ }\NormalTok{bmbstats}\OperatorTok{::}\KeywordTok{describe\_data}\NormalTok{(}
  \DataTypeTok{x =}\NormalTok{ height\_data}\OperatorTok{$}\NormalTok{Female,}
  \DataTypeTok{estimator\_function =}\NormalTok{ bmbstats}\OperatorTok{::}\NormalTok{data\_estimators,}
  \DataTypeTok{control =} \KeywordTok{model\_control}\NormalTok{(}
    \DataTypeTok{seed =} \DecValTok{1667}\NormalTok{,}
    \DataTypeTok{boot\_type =} \StringTok{"bca"}\NormalTok{,}
    \DataTypeTok{boot\_samples =} \DecValTok{2000}\NormalTok{,}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{female\_analysis\_robust <{-}}\StringTok{ }\NormalTok{bmbstats}\OperatorTok{::}\KeywordTok{describe\_data}\NormalTok{(}
  \DataTypeTok{x =}\NormalTok{ height\_data}\OperatorTok{$}\NormalTok{Female,}
...
\NormalTok{tall\_females <{-}}\StringTok{ }\NormalTok{bmbstats}\OperatorTok{::}\KeywordTok{describe\_data}\NormalTok{(}
  \DataTypeTok{x =}\NormalTok{ height\_data}\OperatorTok{$}\NormalTok{Female,}
  \DataTypeTok{estimator\_function =}\NormalTok{ prop\_estimators,}
  \DataTypeTok{control =} \KeywordTok{model\_control}\NormalTok{(}
    \DataTypeTok{seed =} \DecValTok{1667}\NormalTok{,}
    \DataTypeTok{boot\_type =} \StringTok{"bca"}\NormalTok{,}
    \DataTypeTok{boot\_samples =} \DecValTok{2000}\NormalTok{,}
...
\CommentTok{\#> }
\CommentTok{\#>                            estimator        value        lower        upper}
\CommentTok{\#>                                 mean 163.17791620 1.609134e+02 165.33255732}
\CommentTok{\#>                                   SD   8.19937316 7.017929e+00   9.87473324}
\CommentTok{\#>      Over 180cm proportion (t{-}distr)   0.02278501 7.860132e{-}03   0.05965420}
\CommentTok{\#>   Over 180cm proportion (norm{-}distr)   0.02010279 6.171549e{-}03   0.05644849}
\CommentTok{\#>  Over 180cm proportion (brute{-}force)   0.02000000 0.000000e+00   0.06000000}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{tall\_males <{-}}\StringTok{ }\NormalTok{bmbstats}\OperatorTok{::}\KeywordTok{describe\_data}\NormalTok{(}
  \DataTypeTok{x =}\NormalTok{ height\_data}\OperatorTok{$}\NormalTok{Male,}
  \DataTypeTok{estimator\_function =}\NormalTok{ prop\_estimators,}
  \DataTypeTok{control =} \KeywordTok{model\_control}\NormalTok{(}
    \DataTypeTok{seed =} \DecValTok{1667}\NormalTok{,}
    \DataTypeTok{boot\_type =} \StringTok{"bca"}\NormalTok{,}
...
\NormalTok{compare\_groups <{-}}\StringTok{ }\KeywordTok{rbind}\NormalTok{(}
  \KeywordTok{data.frame}\NormalTok{(}\DataTypeTok{group =} \StringTok{"females"}\NormalTok{, tall\_females}\OperatorTok{$}\NormalTok{estimators),}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{height\_data\_long <{-}}\StringTok{ }\KeywordTok{gather}\NormalTok{(}
\NormalTok{  height\_data,}
  \DataTypeTok{key =} \StringTok{"Gender"}\NormalTok{,}
  \DataTypeTok{value =} \StringTok{"Height"}
\NormalTok{)}

\CommentTok{\# Order factors}
\NormalTok{height\_data\_long}\OperatorTok{$}\NormalTok{Gender <{-}}\StringTok{ }\KeywordTok{factor}\NormalTok{(}
\NormalTok{  height\_data\_long}\OperatorTok{$}\NormalTok{Gender,}
...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{independent\_groups\_estimators}\NormalTok{(}
  \DataTypeTok{group\_a =}\NormalTok{ height\_data}\OperatorTok{$}\NormalTok{Female,}
  \DataTypeTok{group\_b =}\NormalTok{ height\_data}\OperatorTok{$}\NormalTok{Male,}
  \DataTypeTok{SESOI\_lower =} \FloatTok{{-}2.5}\NormalTok{,}
  \DataTypeTok{SESOI\_upper =} \FloatTok{2.5}
\NormalTok{)}
\CommentTok{\#>        SESOI lower        SESOI upper        SESOI range          Mean diff }
\CommentTok{\#>        {-}2.50000000         2.50000000         5.00000000        12.72521903 }
\CommentTok{\#>            SD diff          SD pooled           \%CV diff             \% diff }
\CommentTok{\#>        12.41402468         8.77804103        97.55450689         7.79837084 }
\CommentTok{\#>              Ratio          Cohen\textquotesingle{}s d               CLES                OVL }
\CommentTok{\#>         1.07798371         1.44966502         0.84733444         0.46855479 }
\CommentTok{\#> Mean diff to SESOI   SD diff to SESOI             pLower        pEquivalent }
\CommentTok{\#>         2.54504381         2.48280494         0.11148343         0.09457649 }
\CommentTok{\#>            pHigher }
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{males\_females\_comp <{-}}\StringTok{ }\KeywordTok{compare\_independent\_groups}\NormalTok{(}
  \DataTypeTok{group\_a =}\NormalTok{ height\_data}\OperatorTok{$}\NormalTok{Female,}
  \DataTypeTok{group\_b =}\NormalTok{ height\_data}\OperatorTok{$}\NormalTok{Male,}
  \DataTypeTok{SESOI\_lower =} \FloatTok{{-}2.5}\NormalTok{,}
  \DataTypeTok{SESOI\_upper =} \FloatTok{2.5}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{males\_females\_comp\_est <{-}}\StringTok{ }\KeywordTok{compare\_independent\_groups}\NormalTok{(}
  \DataTypeTok{group\_a =}\NormalTok{ height\_data}\OperatorTok{$}\NormalTok{Female,}
  \DataTypeTok{group\_b =}\NormalTok{ height\_data}\OperatorTok{$}\NormalTok{Male,}
  \DataTypeTok{SESOI\_lower =} \FloatTok{{-}2.5}\NormalTok{,}
  \DataTypeTok{SESOI\_upper =} \ControlFlowTok{function}\NormalTok{(group\_a, group\_b, na.rm) \{}
...
\CommentTok{\#>           estimator       value       lower        upper}
\CommentTok{\#>         SESOI lower {-}2.50000000          NA           NA}
\CommentTok{\#>         SESOI upper  1.63987463  1.40101324   1.94141198}
\CommentTok{\#>         SESOI range  4.13987463  3.90101324   4.44141198}
\CommentTok{\#>           Mean diff 12.72521903  9.39979860  16.07945845}
\CommentTok{\#>             SD diff 12.41402468 11.12171677  14.08901524}
\CommentTok{\#>           SD pooled  8.77804103  7.86424134   9.96243822}
\CommentTok{\#>            \%CV diff 97.55450689 74.22144558 135.97174823}
\CommentTok{\#>              \% diff  7.79837084  5.72302737   9.95978160}
\CommentTok{\#>               Ratio  1.07798371  1.05723027   1.09959782}
\CommentTok{\#>           Cohen\textquotesingle{}s d  1.44966502  1.04057626   1.90567697}
\CommentTok{\#>                CLES  0.84733444  0.76901630   0.91107613}
\CommentTok{\#>                 OVL  0.46855479  0.34069164   0.60291087}
\CommentTok{\#>  Mean diff to SESOI  3.07381749  2.26756237   3.95663372}
\CommentTok{\#>    SD diff to SESOI  2.99864749  2.72442801   3.34078108}
\CommentTok{\#>              pLower  0.11148343  0.06178746   0.17758243}
\CommentTok{\#>         pEquivalent  0.07554712  0.05221579   0.09808881}
\CommentTok{\#>             pHigher  0.81296945  0.72639255   0.88497505}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{males\_females\_comp\_inside <{-}}\StringTok{ }\KeywordTok{compare\_independent\_groups}\NormalTok{(}
  \DataTypeTok{group\_a =}\NormalTok{ height\_data}\OperatorTok{$}\NormalTok{Female,}
  \DataTypeTok{group\_b =}\NormalTok{ height\_data}\OperatorTok{$}\NormalTok{Male,}
  \DataTypeTok{SESOI\_lower =} \ControlFlowTok{function}\NormalTok{(group\_a, group\_b, na.rm) \{}
...
\NormalTok{males\_females\_comp\_outside <{-}}\StringTok{ }\KeywordTok{compare\_independent\_groups}\NormalTok{(}
  \DataTypeTok{group\_a =}\NormalTok{ height\_data}\OperatorTok{$}\NormalTok{Female,}
  \DataTypeTok{group\_b =}\NormalTok{ height\_data}\OperatorTok{$}\NormalTok{Male,}
  \DataTypeTok{SESOI\_lower =} \OperatorTok{{-}}\KeywordTok{sd}\NormalTok{(height\_data}\OperatorTok{$}\NormalTok{Female) }\OperatorTok{*}\StringTok{ }\FloatTok{0.2}\NormalTok{,}
  \DataTypeTok{SESOI\_upper =} \KeywordTok{sd}\NormalTok{(height\_data}\OperatorTok{$}\NormalTok{Female) }\OperatorTok{*}\StringTok{ }\FloatTok{0.2}\NormalTok{,}
  \DataTypeTok{control =} \KeywordTok{model\_control}\NormalTok{(}\DataTypeTok{seed =} \DecValTok{1667}\NormalTok{)}
\NormalTok{)}
...
\NormalTok{compare\_analyses <{-}}\StringTok{ }\KeywordTok{rbind}\NormalTok{(}
  \KeywordTok{data.frame}\NormalTok{(}\DataTypeTok{group =} \StringTok{"inside"}\NormalTok{, males\_females\_comp\_inside}\OperatorTok{$}\NormalTok{estimators),}
...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{plot\_pair\_changes}\NormalTok{(}
  \DataTypeTok{group\_a =}\NormalTok{ bench\_press\_data}\OperatorTok{$}\StringTok{\textasciigrave{}}\DataTypeTok{Pre{-}test (true)}\StringTok{\textasciigrave{}}\NormalTok{,}
  \DataTypeTok{group\_b =}\NormalTok{ bench\_press\_data}\OperatorTok{$}\StringTok{\textasciigrave{}}\DataTypeTok{Post{-}test (true)}\StringTok{\textasciigrave{}}\NormalTok{,}
  \DataTypeTok{group\_a\_label =} \StringTok{"True Pre{-}test"}\NormalTok{,}
  \DataTypeTok{group\_b\_label =} \StringTok{"True Post{-}test"}\NormalTok{,}
...
\begin{Highlighting}[]
\KeywordTok{plot\_pair\_changes}\NormalTok{(}
  \DataTypeTok{group\_a =}\NormalTok{ bench\_press\_data}\OperatorTok{$}\StringTok{\textasciigrave{}}\DataTypeTok{Pre{-}test (observed)}\StringTok{\textasciigrave{}}\NormalTok{,}
  \DataTypeTok{group\_b =}\NormalTok{ bench\_press\_data}\OperatorTok{$}\StringTok{\textasciigrave{}}\DataTypeTok{Post{-}test (observed)}\StringTok{\textasciigrave{}}\NormalTok{,}
  \DataTypeTok{group\_a\_label =} \StringTok{"Observed Pre{-}test"}\NormalTok{,}
  \DataTypeTok{group\_b\_label =} \StringTok{"Observed Post{-}test"}\NormalTok{,}
  \DataTypeTok{SESOI\_lower =} \DecValTok{{-}5}\NormalTok{,}
  \DataTypeTok{SESOI\_upper =} \DecValTok{5}
\NormalTok{)}
\end{Highlighting}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{obs\_change\_analysis <{-}}\StringTok{ }\NormalTok{bmbstats}\OperatorTok{::}\KeywordTok{describe\_data}\NormalTok{(}
  \DataTypeTok{x =}\NormalTok{ bench\_press\_data}\OperatorTok{$}\StringTok{\textasciigrave{}}\DataTypeTok{Change (observed)}\StringTok{\textasciigrave{}}\NormalTok{,}
  \DataTypeTok{estimator\_function =}\NormalTok{ bmbstats}\OperatorTok{::}\NormalTok{data\_estimators\_simple,}
  \DataTypeTok{control =} \KeywordTok{model\_control}\NormalTok{(}
    \DataTypeTok{seed =} \DecValTok{1667}\NormalTok{,}
    \DataTypeTok{boot\_type =} \StringTok{"perc"}\NormalTok{,}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{true\_change\_analysis <{-}}\StringTok{ }\NormalTok{bmbstats}\OperatorTok{::}\KeywordTok{describe\_data}\NormalTok{(}
  \DataTypeTok{x =}\NormalTok{ bench\_press\_data}\OperatorTok{$}\StringTok{\textasciigrave{}}\DataTypeTok{Change (true)}\StringTok{\textasciigrave{}}\NormalTok{,}
  \DataTypeTok{estimator\_function =}\NormalTok{ bmbstats}\OperatorTok{::}\NormalTok{data\_estimators\_simple,}
  \DataTypeTok{control =} \KeywordTok{model\_control}\NormalTok{(}
    \DataTypeTok{seed =} \DecValTok{1667}\NormalTok{,}
    \DataTypeTok{boot\_type =} \StringTok{"perc"}\NormalTok{,}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{true\_pre\_post <{-}}\StringTok{ }\NormalTok{bmbstats}\OperatorTok{::}\KeywordTok{compare\_dependent\_groups}\NormalTok{(}
  \DataTypeTok{pre =}\NormalTok{ bench\_press\_data}\OperatorTok{$}\StringTok{\textasciigrave{}}\DataTypeTok{Pre{-}test (true)}\StringTok{\textasciigrave{}}\NormalTok{,}
  \DataTypeTok{post =}\NormalTok{ bench\_press\_data}\OperatorTok{$}\StringTok{\textasciigrave{}}\DataTypeTok{Post{-}test (true)}\StringTok{\textasciigrave{}}\NormalTok{,}
  \DataTypeTok{SESOI\_lower =} \DecValTok{{-}5}\NormalTok{,}
  \DataTypeTok{SESOI\_upper =} \DecValTok{5}\NormalTok{,}
  \DataTypeTok{estimator\_function =}\NormalTok{ bmbstats}\OperatorTok{::}\NormalTok{dependent\_groups\_estimators,}
  \DataTypeTok{control =} \KeywordTok{model\_control}\NormalTok{(}
    \DataTypeTok{seed =} \DecValTok{1667}\NormalTok{,}
    \DataTypeTok{boot\_type =} \StringTok{"perc"}\NormalTok{,}
    \DataTypeTok{boot\_samples =} \DecValTok{1000}\NormalTok{,}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{obs\_pre\_post <{-}}\StringTok{ }\NormalTok{bmbstats}\OperatorTok{::}\KeywordTok{compare\_dependent\_groups}\NormalTok{(}
  \DataTypeTok{pre =}\NormalTok{ bench\_press\_data}\OperatorTok{$}\StringTok{\textasciigrave{}}\DataTypeTok{Pre{-}test (observed)}\StringTok{\textasciigrave{}}\NormalTok{,}
  \DataTypeTok{post =}\NormalTok{ bench\_press\_data}\OperatorTok{$}\StringTok{\textasciigrave{}}\DataTypeTok{Post{-}test (observed)}\StringTok{\textasciigrave{}}\NormalTok{,}
  \DataTypeTok{SESOI\_lower =} \DecValTok{{-}5}\NormalTok{,}
  \DataTypeTok{SESOI\_upper =} \DecValTok{5}\NormalTok{,}
  \DataTypeTok{estimator\_function =}\NormalTok{ bmbstats}\OperatorTok{::}\NormalTok{dependent\_groups\_estimators,}
  \DataTypeTok{control =} \KeywordTok{model\_control}\NormalTok{(}
...
\CommentTok{\#> }
\CommentTok{\#>             estimator       value       lower       upper}
\CommentTok{\#>           SESOI lower {-}5.00000000 {-}5.00000000 {-}5.00000000}
\CommentTok{\#>           SESOI upper  5.00000000          NA          NA}
\CommentTok{\#>           SESOI range 10.00000000          NA          NA}
\CommentTok{\#>           Mean change 13.26634977  9.82939542 17.26567091}
\CommentTok{\#>             SD change 10.32696439  7.53316566 12.40584025}
\CommentTok{\#>            \%CV change 77.84329951 55.95245477 97.95459056}
\CommentTok{\#>              \% change 13.07536952  9.64149847 17.10620410}
\CommentTok{\#>                 Ratio  1.13075370  1.09641498  1.17106204}
\CommentTok{\#>             Cohen\textquotesingle{}s d  1.73487556  1.23093674  2.63074534}
\CommentTok{\#>                  CLES  0.80381999  0.73779303  0.88834207}
\CommentTok{\#>                   OVL  0.38570219  0.18838477  0.53824551}
\CommentTok{\#>  Mean change to SESOI  1.32663498  0.98293954  1.72656709}
\CommentTok{\#>    SD change to SESOI  1.03269644  0.75331657  1.24058402}
\CommentTok{\#>                pLower  0.04648926  0.01380798  0.07714882}
\CommentTok{\#>           pEquivalent  0.17017990  0.09737292  0.23894195}
\CommentTok{\#>               pHigher  0.78333084  0.69453555  0.88551971}
\end{Highlighting}
\end{Shaded}
...
\CommentTok{\# Plot the estimators}
\NormalTok{compare\_analyses <{-}}\StringTok{ }\KeywordTok{rbind}\NormalTok{(}
  \KeywordTok{data.frame}\NormalTok{(}\DataTypeTok{group =} \StringTok{"true"}\NormalTok{, true\_pre\_post}\OperatorTok{$}\NormalTok{estimators),}
...
\CommentTok{\# {-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}}
\NormalTok{adj\_pre\_post <{-}}\StringTok{ }\NormalTok{bmbstats}\OperatorTok{::}\KeywordTok{compare\_dependent\_groups}\NormalTok{(}
  \DataTypeTok{pre =}\NormalTok{ bench\_press\_data}\OperatorTok{$}\StringTok{\textasciigrave{}}\DataTypeTok{Pre{-}test (observed)}\StringTok{\textasciigrave{}}\NormalTok{,}
  \DataTypeTok{post =}\NormalTok{ bench\_press\_data}\OperatorTok{$}\StringTok{\textasciigrave{}}\DataTypeTok{Post{-}test (observed)}\StringTok{\textasciigrave{}}\NormalTok{,}
  \DataTypeTok{SESOI\_lower =} \DecValTok{{-}5}\NormalTok{,}
  \DataTypeTok{SESOI\_upper =} \DecValTok{5}\NormalTok{,}
  \DataTypeTok{estimator\_function =}\NormalTok{ adjusted\_estimators,}
  \DataTypeTok{control =} \KeywordTok{model\_control}\NormalTok{(}
    \DataTypeTok{seed =} \DecValTok{1667}\NormalTok{,}
    \DataTypeTok{boot\_type =} \StringTok{"perc"}\NormalTok{,}
    \DataTypeTok{boot\_samples =} \DecValTok{1000}\NormalTok{,}
...
\CommentTok{\#>           SESOI upper  5.00000000           NA          NA}
\CommentTok{\#>           SESOI range 10.00000000           NA          NA}
\CommentTok{\#>           Mean change 13.26634977  9.829395423 17.26567091}
\CommentTok{\#>             SD change  9.70289614  6.651960703 11.89137806}
\CommentTok{\#>            \%CV change 73.13915511 50.327816706 93.01853927}
\CommentTok{\#>              \% change 13.07536952  9.641498467 17.10620410}
\CommentTok{\#>                 Ratio  1.13075370  1.096414985  1.17106204}
\CommentTok{\#>             Cohen\textquotesingle{}s d  1.73487556  1.230936741  2.63074534}
\CommentTok{\#>                  CLES  0.80381999  0.737793033  0.88834207}
\CommentTok{\#>                   OVL  0.38570219  0.188384768  0.53824551}
\CommentTok{\#>  Mean change to SESOI  1.32663498  0.982939542  1.72656709}
\CommentTok{\#>    SD change to SESOI  0.97028961  0.665196070  1.18913781}
\CommentTok{\#>                pLower  0.03758233  0.007977625  0.06801839}
\CommentTok{\#>           pEquivalent  0.16484497  0.085648118  0.23506532}
\CommentTok{\#>               pHigher  0.79757270  0.708039046  0.90137633}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{bmbstats}\OperatorTok{::}\KeywordTok{plot\_pair\_lm}\NormalTok{(}
  \DataTypeTok{predictor =}\NormalTok{ yoyo\_mas\_data}\OperatorTok{$}\NormalTok{MAS,}
  \DataTypeTok{outcome =}\NormalTok{ yoyo\_mas\_data}\OperatorTok{$}\NormalTok{YoYoIR1,}
  \DataTypeTok{predictor\_label =} \StringTok{"MAS"}\NormalTok{,}
  \DataTypeTok{outcome\_label =} \StringTok{"YoYoIR1"}\NormalTok{,}
  \DataTypeTok{SESOI\_lower =} \DecValTok{{-}40}\NormalTok{,}
  \DataTypeTok{SESOI\_upper =} \DecValTok{40}
\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{boot\_relationship <{-}}\StringTok{ }\NormalTok{bmbstats}\OperatorTok{::}\KeywordTok{describe\_relationship}\NormalTok{(}
  \DataTypeTok{predictor =}\NormalTok{ yoyo\_mas\_data}\OperatorTok{$}\NormalTok{MAS,}
  \DataTypeTok{outcome =}\NormalTok{ yoyo\_mas\_data}\OperatorTok{$}\NormalTok{YoYoIR1,}
  \DataTypeTok{SESOI\_lower =} \DecValTok{{-}40}\NormalTok{,}
...
\begin{Highlighting}[]
\NormalTok{boot\_relationship <{-}}\StringTok{ }\NormalTok{bmbstats}\OperatorTok{::}\KeywordTok{describe\_relationship}\NormalTok{(}
  \DataTypeTok{outcome =}\NormalTok{ yoyo\_mas\_data}\OperatorTok{$}\NormalTok{MAS,}
  \DataTypeTok{predictor =}\NormalTok{ yoyo\_mas\_data}\OperatorTok{$}\NormalTok{YoYoIR1,}
  \DataTypeTok{SESOI\_lower =} \FloatTok{{-}0.5}\NormalTok{,}
  \DataTypeTok{SESOI\_upper =} \FloatTok{0.5}\NormalTok{,}
  \DataTypeTok{estimator\_function =}\NormalTok{ bmbstats}\OperatorTok{::}\NormalTok{relationship\_lm\_estimators,}
  \DataTypeTok{control =} \KeywordTok{model\_control}\NormalTok{(}
    \DataTypeTok{seed =} \DecValTok{1667}\NormalTok{,}
    \DataTypeTok{boot\_type =} \StringTok{"perc"}\NormalTok{,}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{plot\_data <{-}}\StringTok{ }\KeywordTok{rbind}\NormalTok{(}
  \KeywordTok{data.frame}\NormalTok{(}\DataTypeTok{model =} \StringTok{"rpart"}\NormalTok{, model3}\OperatorTok{$}\NormalTok{cross\_validation}\OperatorTok{$}\NormalTok{performance}\OperatorTok{$}\NormalTok{summary}\OperatorTok{$}\NormalTok{overall),}
...
\CommentTok{\#>    model        metric      training training.pooled testing.pooled        mean}
\CommentTok{\#> 1  rpart           MBE  2.030618e{-}16   {-}3.045865e{-}16     0.03760974  0.03641386}
\CommentTok{\#> 2  rpart           MAE  2.023389e+00    2.268546e+00     2.60389737  2.57549008}
\CommentTok{\#> 3  rpart          RMSE  2.591359e+00    2.765355e+00     3.29362285  3.19456487}
\CommentTok{\#> 4  rpart          PPER  3.621870e{-}01    3.437038e{-}01     0.29087228  0.27713101}
\CommentTok{\#> 5  rpart SESOI to RMSE  9.639014e{-}01    8.905739e{-}01     0.74773376  0.83310652}
\CommentTok{\#> 6  rpart     R{-}squared  8.227265e{-}01    7.981214e{-}01     0.71366153  0.74453263}
\CommentTok{\#> 7  rpart        MinErr {-}5.699018e+00   {-}6.168662e+00    {-}9.88715278 {-}4.49333669}
\CommentTok{\#> 8  rpart        MaxErr  6.097584e+00    6.427283e+00     7.22167137  4.47699323}
\CommentTok{\#> 9  rpart     MaxAbsErr  6.097584e+00    6.427283e+00     9.88715278  5.86162382}
\CommentTok{\#> 10  poly           MBE {-}1.299275e{-}14    2.060564e{-}15    {-}0.03724767 {-}0.02930855}
\CommentTok{\#> 11  poly           MAE  1.534398e+00    1.509623e+00     1.77622691  1.77362879}
\CommentTok{\#> 12  poly          RMSE  1.837539e+00    1.807043e+00     2.10648622  2.07925558}
\CommentTok{\#> 13  poly          PPER  4.925435e{-}01    5.041349e{-}01     0.44022003  0.40113906}
\CommentTok{\#> 14  poly SESOI to RMSE  1.359326e+00    1.362863e+00     1.16912846  1.22806404}
\CommentTok{\#> 15  poly     R{-}squared  9.108623e{-}01    9.137963e{-}01     0.88289646  0.89017328}
\CommentTok{\#> 16  poly        MinErr {-}3.676547e+00   {-}4.335315e+00    {-}4.57284164 {-}2.99135803}
\CommentTok{\#> 17  poly        MaxErr  3.819068e+00    4.380287e+00     4.43506709  2.54927044}
\CommentTok{\#> 18  poly     MaxAbsErr  3.819068e+00    4.380287e+00     4.57284164  3.45414085}
\CommentTok{\#>            SD        min        max}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{rmse\_rpart <{-}}\StringTok{ }\KeywordTok{filter}\NormalTok{(}
\NormalTok{  model3}\OperatorTok{$}\NormalTok{cross\_validation}\OperatorTok{$}\NormalTok{performance}\OperatorTok{$}\NormalTok{folds}\OperatorTok{$}\NormalTok{testing,}
\NormalTok{  metric }\OperatorTok{==}\StringTok{ "RMSE"}
\NormalTok{)}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{rmse\_poly <{-}}\StringTok{ }\KeywordTok{filter}\NormalTok{(}
\NormalTok{  model4}\OperatorTok{$}\NormalTok{cross\_validation}\OperatorTok{$}\NormalTok{performance}\OperatorTok{$}\NormalTok{folds}\OperatorTok{$}\NormalTok{testing,}
\NormalTok{  metric }\OperatorTok{==}\StringTok{ "RMSE"}
\NormalTok{)}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{rmse\_data <{-}}\StringTok{ }\KeywordTok{rbind}\NormalTok{(}
  \KeywordTok{data.frame}\NormalTok{(}\DataTypeTok{model =} \StringTok{"rpart"}\NormalTok{, }\DataTypeTok{value =}\NormalTok{ rmse\_rpart}\OperatorTok{$}\NormalTok{value),}
...
\NormalTok{bmbstats}\OperatorTok{::}\KeywordTok{plot\_raincloud}\NormalTok{(}
\NormalTok{  rmse\_data,}
  \DataTypeTok{value =} \StringTok{"value"}\NormalTok{,}
  \DataTypeTok{value\_label =} \StringTok{"RMSE"}\NormalTok{,}
  \DataTypeTok{groups =} \StringTok{"model"}
\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{rmse\_perf <{-}}\StringTok{ }\NormalTok{bmbstats}\OperatorTok{::}\KeywordTok{compare\_dependent\_groups}\NormalTok{(}
  \DataTypeTok{pre =}\NormalTok{ rmse\_rpart}\OperatorTok{$}\NormalTok{value,}
...
\CommentTok{\#> }
\CommentTok{\#>             estimator        value         lower        upper}
\CommentTok{\#>           SESOI lower  {-}0.13539863   {-}0.17607368  {-}0.10927225}
\CommentTok{\#>           SESOI upper   0.13539863    0.10927225   0.17607368}
\CommentTok{\#>           SESOI range   0.27079726    0.21854450   0.35214735}
\CommentTok{\#>           Mean change  {-}1.11530929   {-}1.32646984  {-}0.89455705}
\CommentTok{\#>             SD change   0.76022031    0.60218574   0.99219147}
\CommentTok{\#>            \%CV change {-}68.16228649 {-}108.17299822 {-}50.50157994}
\CommentTok{\#>              \% change {-}30.38499807  {-}35.93194876 {-}19.10373522}
\CommentTok{\#>                 Ratio   0.69615002    0.64068051   0.80896265}
\CommentTok{\#>             Cohen\textquotesingle{}s d  {-}1.64744544   {-}2.17427538  {-}1.02403852}
\CommentTok{\#>                  CLES   0.06573315    0.02725296   0.16669235}
\CommentTok{\#>                   OVL   0.41009713    0.27810102   0.60868406}
\CommentTok{\#>  Mean change to SESOI  {-}4.11861361   {-}5.43568845  {-}2.56009630}
\CommentTok{\#>    SD change to SESOI   2.80734121    2.51010263   3.14489890}
\CommentTok{\#>                pLower   0.89827180    0.76960554   0.95994450}
\CommentTok{\#>           pEquivalent   0.04856260    0.02183432   0.09330646}
\CommentTok{\#>               pHigher   0.05316560    0.01748864   0.13895348}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{rmse\_NHST <{-}}\StringTok{ }\NormalTok{bmbstats}\OperatorTok{::}\KeywordTok{bootstrap\_NHST}\NormalTok{(}
\NormalTok{  rmse\_perf,}
  \DataTypeTok{estimator =} \StringTok{"Mean change"}\NormalTok{,}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{resid\_data <{-}}\StringTok{ }\KeywordTok{rbind}\NormalTok{(}
  \KeywordTok{data.frame}\NormalTok{(}\DataTypeTok{model =} \StringTok{"rpart"}\NormalTok{, }\DataTypeTok{value =}\NormalTok{ model3}\OperatorTok{$}\NormalTok{cross\_validation}\OperatorTok{$}\NormalTok{data}\OperatorTok{$}\NormalTok{testing}\OperatorTok{$}\NormalTok{residual),}
...
\NormalTok{bmbstats}\OperatorTok{::}\KeywordTok{plot\_raincloud}\NormalTok{(}
\NormalTok{  resid\_data,}
  \DataTypeTok{value =} \StringTok{"value"}\NormalTok{,}
  \DataTypeTok{value\_label =} \StringTok{"CV residuals"}\NormalTok{,}
  \DataTypeTok{groups =} \StringTok{"model"}
\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\begin{Highlighting}[]
\NormalTok{bmbstats}\OperatorTok{::}\KeywordTok{plot\_raincloud}\NormalTok{(}
  \KeywordTok{data.frame}\NormalTok{(}\DataTypeTok{diff =}\NormalTok{ model4}\OperatorTok{$}\NormalTok{cross\_validation}\OperatorTok{$}\NormalTok{data}\OperatorTok{$}\NormalTok{testing}\OperatorTok{$}\NormalTok{residual }\OperatorTok{{-}}
\StringTok{    }\NormalTok{model3}\OperatorTok{$}\NormalTok{cross\_validation}\OperatorTok{$}\NormalTok{data}\OperatorTok{$}\NormalTok{testing}\OperatorTok{$}\NormalTok{residual),}
  \DataTypeTok{value =} \StringTok{"diff"}\NormalTok{,}
  \DataTypeTok{value\_label =} \StringTok{"CV residuals difference"}
\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{resid\_perf <{-}}\StringTok{ }\NormalTok{bmbstats}\OperatorTok{::}\KeywordTok{compare\_dependent\_groups}\NormalTok{(}
  \DataTypeTok{pre =}\NormalTok{ model3}\OperatorTok{$}\NormalTok{cross\_validation}\OperatorTok{$}\NormalTok{data}\OperatorTok{$}\NormalTok{testing}\OperatorTok{$}\NormalTok{residual,}
...
\CommentTok{\#> }
\CommentTok{\#>             estimator         value         lower         upper}
\CommentTok{\#>           SESOI lower {-}6.596246e{-}01 {-}7.094456e{-}01 {-}6.153383e{-}01}
\CommentTok{\#>           SESOI upper  6.596246e{-}01  6.153383e{-}01  7.094456e{-}01}
\CommentTok{\#>           SESOI range  1.319249e+00  1.230677e+00  1.418891e+00}
\CommentTok{\#>           Mean change {-}7.485741e{-}02 {-}3.678773e{-}01  2.267774e{-}01}
\CommentTok{\#>             SD change  2.853680e+00  2.711641e+00  3.019229e+00}
\CommentTok{\#>            \%CV change {-}3.812154e+03 {-}1.203382e+06 {-}1.112797e+03}
\CommentTok{\#>              \% change {-}1.816303e+01 {-}8.898433e+01  6.621511e+01}
\CommentTok{\#>                 Ratio  8.183697e{-}01  1.101567e{-}01  1.662151e+00}
\CommentTok{\#>             Cohen\textquotesingle{}s d {-}2.269697e{-}02 {-}1.118320e{-}01  6.659056e{-}02}
\CommentTok{\#>                  CLES  4.923722e{-}01  4.625656e{-}01  5.225228e{-}01}
\CommentTok{\#>                   OVL  9.909454e{-}01  9.689477e{-}01  9.999341e{-}01}
\CommentTok{\#>  Mean change to SESOI {-}5.674243e{-}02 {-}2.795801e{-}01  1.664764e{-}01}
\CommentTok{\#>    SD change to SESOI  2.163109e+00  2.042661e+00  2.298416e+00}
\CommentTok{\#>                pLower  4.188782e{-}01  3.767829e{-}01  4.605721e{-}01}
\CommentTok{\#>           pEquivalent  1.826035e{-}01  1.721664e{-}01  1.933616e{-}01}
\CommentTok{\#>               pHigher  3.985183e{-}01  3.604887e{-}01  4.386698e{-}01}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{model4.boot.perf <{-}}\StringTok{ }\NormalTok{bmbstats}\OperatorTok{::}\KeywordTok{bmbstats}\NormalTok{(}
  \DataTypeTok{data =}\NormalTok{ sinus\_data, }
  \DataTypeTok{estimator\_function =} \ControlFlowTok{function}\NormalTok{(data, SESOI\_lower, SESOI\_upper, na.rm, init\_boot) \{}
\NormalTok{    model <{-}}\StringTok{ }\KeywordTok{lm}\NormalTok{(observed\_y }\OperatorTok{\textasciitilde{}}\StringTok{ }\KeywordTok{poly}\NormalTok{(x, }\DecValTok{3}\NormalTok{), data)}
    
    \CommentTok{\# Return model performance metrics}
\NormalTok{    bmbstats}\OperatorTok{::}\KeywordTok{performance\_metrics}\NormalTok{(}
      \DataTypeTok{observed =}\NormalTok{ data}\OperatorTok{$}\NormalTok{observed\_y,}
      \DataTypeTok{predicted =} \KeywordTok{predict}\NormalTok{(model),}
      \DataTypeTok{SESOI\_lower =}\NormalTok{ SESOI\_lower,}
      \DataTypeTok{SESOI\_upper =}\NormalTok{ SESOI\_upper,}
      \DataTypeTok{na.rm =}\NormalTok{ na.rm}
\NormalTok{    )}
...
\CommentTok{\#> }
\CommentTok{\#>      estimator         value         lower         upper}
\CommentTok{\#>            MBE {-}1.299275e{-}14 {-}4.125793e{-}14  1.055661e{-}14}
\CommentTok{\#>            MAE  1.534398e+00  1.290075e+00  2.119985e+00}
\CommentTok{\#>           RMSE  1.837539e+00  1.620042e+00  2.370531e+00}
\CommentTok{\#>           PPER  0.000000e+00            NA            NA}
\CommentTok{\#>  SESOI to RMSE  0.000000e+00            NA            NA}
\CommentTok{\#>      R{-}squared  9.108623e{-}01  8.286065e{-}01  9.396944e{-}01}
\CommentTok{\#>         MinErr {-}3.676547e+00 {-}5.001168e+00 {-}3.035433e+00}
\CommentTok{\#>         MaxErr  3.819068e+00  2.958894e+00  5.388544e+00}
\CommentTok{\#>      MaxAbsErr  3.819068e+00  3.001014e+00  5.097689e+00}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{bmbstats}\OperatorTok{::}\KeywordTok{plot\_pair\_BA}\NormalTok{(}
  \DataTypeTok{predictor =}\NormalTok{ agreement\_data}\OperatorTok{$}\NormalTok{True\_score,}
  \DataTypeTok{outcome =}\NormalTok{ agreement\_data}\OperatorTok{$}\NormalTok{Criterion\_score.trial1,}
  \DataTypeTok{predictor\_label =} \StringTok{"True Score"}\NormalTok{,}
  \DataTypeTok{outcome\_label =} \StringTok{"Criterion Score"}\NormalTok{,}
  \DataTypeTok{SESOI\_lower =} \FloatTok{{-}2.5}\NormalTok{,}
  \DataTypeTok{SESOI\_upper =} \FloatTok{2.5}
\NormalTok{)}
\end{Highlighting}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{lm\_method <{-}}\StringTok{ }\ControlFlowTok{function}\NormalTok{(data,}
\NormalTok{                      criterion,}
\NormalTok{                      practical,}
                      \DataTypeTok{SESOI\_lower =} \DecValTok{0}\NormalTok{,}
                      \DataTypeTok{SESOI\_upper =} \DecValTok{0}\NormalTok{,}
...
\NormalTok{  PPER <{-}}\StringTok{ }\NormalTok{stats}\OperatorTok{::}\KeywordTok{pt}\NormalTok{((SESOI\_upper }\OperatorTok{{-}}\StringTok{ }\NormalTok{mean\_diff) }\OperatorTok{/}\StringTok{ }\NormalTok{rse, }\DataTypeTok{df =}\NormalTok{ n\_obs }\OperatorTok{{-}}\StringTok{ }\DecValTok{1}\NormalTok{) }\OperatorTok{{-}}
\StringTok{    }\NormalTok{stats}\OperatorTok{::}\KeywordTok{pt}\NormalTok{((SESOI\_lower }\OperatorTok{{-}}\StringTok{ }\NormalTok{mean\_diff) }\OperatorTok{/}\StringTok{ }\NormalTok{rse, }\DataTypeTok{df =}\NormalTok{ n\_obs }\OperatorTok{{-}}\StringTok{ }\DecValTok{1}\NormalTok{)}

  \KeywordTok{c}\NormalTok{(}
    \StringTok{"Intercept"}\NormalTok{ =}\StringTok{ }\NormalTok{intercept,}
    \StringTok{"Slope"}\NormalTok{ =}\StringTok{ }\NormalTok{slope,}
    \StringTok{"RSE"}\NormalTok{ =}\StringTok{ }\NormalTok{rse,}
    \DataTypeTok{PPER =}\NormalTok{ PPER}
\NormalTok{  )}
\NormalTok{\}}
...
\NormalTok{  difference\_validity}\OperatorTok{$}\NormalTok{estimators[}\DecValTok{2}\NormalTok{, ],}
\NormalTok{  lm\_validity}\OperatorTok{$}\NormalTok{estimators[}\DecValTok{3}\NormalTok{, ]}
\NormalTok{)}
\CommentTok{\#>   estimator     value     lower     upper}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{bmbstats}\OperatorTok{::}\KeywordTok{plot\_pair\_OLP}\NormalTok{(}
  \DataTypeTok{predictor =}\NormalTok{ agreement\_data}\OperatorTok{$}\NormalTok{True\_score,}
  \DataTypeTok{outcome =}\NormalTok{ agreement\_data}\OperatorTok{$}\NormalTok{Criterion\_score.trial1,}
  \DataTypeTok{predictor\_label =} \StringTok{"True Score"}\NormalTok{,}
  \DataTypeTok{outcome\_label =} \StringTok{"Criterion Score"}\NormalTok{,}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{olp\_method <{-}}\StringTok{ }\ControlFlowTok{function}\NormalTok{(data,}
\NormalTok{                      criterion,}
\NormalTok{                      practical,}
                      \DataTypeTok{SESOI\_lower =} \DecValTok{0}\NormalTok{,}
                      \DataTypeTok{SESOI\_upper =} \DecValTok{0}\NormalTok{,}
...
\NormalTok{  olp\_model <{-}}\StringTok{ }\NormalTok{bmbstats}\OperatorTok{::}\KeywordTok{OLP\_regression}\NormalTok{(}
    \DataTypeTok{outcome =}\NormalTok{ criterion\_obs,}
    \DataTypeTok{predictor =}\NormalTok{ practical\_obs,}
    \DataTypeTok{na.rm =}\NormalTok{ na.rm)}
...
\NormalTok{  PPER <{-}}\StringTok{ }\NormalTok{stats}\OperatorTok{::}\KeywordTok{pt}\NormalTok{((SESOI\_upper) }\OperatorTok{/}\StringTok{ }\NormalTok{rse, }\DataTypeTok{df =}\NormalTok{ n\_obs }\OperatorTok{{-}}\StringTok{ }\DecValTok{1}\NormalTok{) }\OperatorTok{{-}}
\StringTok{    }\NormalTok{stats}\OperatorTok{::}\KeywordTok{pt}\NormalTok{((SESOI\_lower) }\OperatorTok{/}\StringTok{ }\NormalTok{rse, }\DataTypeTok{df =}\NormalTok{ n\_obs }\OperatorTok{{-}}\StringTok{ }\DecValTok{1}\NormalTok{)}
...
\KeywordTok{olp\_method}\NormalTok{(}
  \DataTypeTok{data =}\NormalTok{ agreement\_data,}
  \DataTypeTok{criterion =} \StringTok{"Criterion\_score.trial1"}\NormalTok{,}
  \DataTypeTok{practical =} \StringTok{"True\_score"}\NormalTok{,}
  \DataTypeTok{SESOI\_lower =} \FloatTok{{-}2.5}\NormalTok{,}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{rand\_err\_estimates <{-}}\StringTok{ }\KeywordTok{rbind}\NormalTok{(}
  \KeywordTok{data.frame}\NormalTok{(}\DataTypeTok{outcome =} \StringTok{"Criterion"}\NormalTok{, }\DataTypeTok{method =} \StringTok{"Difference"}\NormalTok{, difference\_validity}\OperatorTok{$}\NormalTok{estimators[}\DecValTok{2}\NormalTok{, ]),}
  \KeywordTok{data.frame}\NormalTok{(}\DataTypeTok{outcome =} \StringTok{"True"}\NormalTok{, }\DataTypeTok{method =} \StringTok{"Difference"}\NormalTok{, difference\_validity\_flip}\OperatorTok{$}\NormalTok{estimators[}\DecValTok{2}\NormalTok{, ]),}
  \KeywordTok{data.frame}\NormalTok{(}\DataTypeTok{outcome =} \StringTok{"Criterion"}\NormalTok{, }\DataTypeTok{method =} \StringTok{"lm"}\NormalTok{, lm\_validity}\OperatorTok{$}\NormalTok{estimators[}\DecValTok{3}\NormalTok{, ]),}
  \KeywordTok{data.frame}\NormalTok{(}\DataTypeTok{outcome =} \StringTok{"True"}\NormalTok{, }\DataTypeTok{method =} \StringTok{"lm"}\NormalTok{, lm\_validity\_flip}\OperatorTok{$}\NormalTok{estimators[}\DecValTok{3}\NormalTok{, ]),}
  \KeywordTok{data.frame}\NormalTok{(}\DataTypeTok{outcome =} \StringTok{"Criterion"}\NormalTok{, }\DataTypeTok{method =} \StringTok{"olp"}\NormalTok{, olp\_validity}\OperatorTok{$}\NormalTok{estimators[}\DecValTok{3}\NormalTok{, ]),}
  \KeywordTok{data.frame}\NormalTok{(}\DataTypeTok{outcome =} \StringTok{"True"}\NormalTok{, }\DataTypeTok{method =} \StringTok{"olp"}\NormalTok{, olp\_validity\_flip}\OperatorTok{$}\NormalTok{estimators[}\DecValTok{3}\NormalTok{, ])}
\NormalTok{)}

\KeywordTok{print}\NormalTok{(rand\_err\_estimates, }\DataTypeTok{row.names =} \OtherTok{FALSE}\NormalTok{)}
\CommentTok{\#>    outcome     method estimator     value     lower     upper}
\CommentTok{\#>  Criterion Difference   SD diff 0.2612583 0.1964889 0.3457962}
\CommentTok{\#>       True Difference   SD diff 0.2612583 0.1964889 0.3457962}
\CommentTok{\#>  Criterion         lm       RSE 0.2643645 0.1859689 0.3575745}
\CommentTok{\#>       True         lm       RSE 0.2618619 0.1813661 0.3559808}
\CommentTok{\#>  Criterion        olp       RSE 0.2644390 0.1859924 0.3579299}
\CommentTok{\#>       True        olp       RSE 0.2619357 0.1812142 0.3560398}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{bmbstats}\OperatorTok{::}\KeywordTok{plot\_pair\_lm}\NormalTok{(}
  \DataTypeTok{predictor =}\NormalTok{ agreement\_data}\OperatorTok{$}\NormalTok{True\_score,}
  \DataTypeTok{outcome =}\NormalTok{ agreement\_data}\OperatorTok{$}\NormalTok{Practical\_score.trial1,}
  \DataTypeTok{predictor\_label =} \StringTok{"True Score"}\NormalTok{,}
  \DataTypeTok{outcome\_label =} \StringTok{"Practical Score"}
\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\begin{Highlighting}[]
\NormalTok{bmbstats}\OperatorTok{::}\KeywordTok{plot\_pair\_lm}\NormalTok{(}
  \DataTypeTok{predictor =}\NormalTok{ agreement\_data}\OperatorTok{$}\NormalTok{Criterion\_score.trial1,}
  \DataTypeTok{outcome =}\NormalTok{ agreement\_data}\OperatorTok{$}\NormalTok{Practical\_score.trial1,}
  \DataTypeTok{predictor\_label =} \StringTok{"Criterion Score"}\NormalTok{,}
  \DataTypeTok{outcome\_label =} \StringTok{"Practical Score"}
\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{practical\_estimators <{-}}\StringTok{ }\KeywordTok{rbind}\NormalTok{(}
  \KeywordTok{data.frame}\NormalTok{(}
    \DataTypeTok{method =} \StringTok{"DGP"}\NormalTok{,}
    \DataTypeTok{estimator =} \KeywordTok{c}\NormalTok{(}\StringTok{"Intercept"}\NormalTok{, }\StringTok{"Slope"}\NormalTok{, }\StringTok{"RSE"}\NormalTok{),}
    \DataTypeTok{value =} \KeywordTok{c}\NormalTok{(practical\_fixed, practical\_proportional, practical\_random),}
    \DataTypeTok{lower =} \OtherTok{NA}\NormalTok{,}
    \DataTypeTok{upper =} \OtherTok{NA}
\NormalTok{  ),}
  \KeywordTok{data.frame}\NormalTok{(}\DataTypeTok{method =} \StringTok{"True lm"}\NormalTok{, lm\_validity\_practical}\OperatorTok{$}\NormalTok{estimators[}\DecValTok{1}\OperatorTok{:}\DecValTok{3}\NormalTok{, ]),}
  \KeywordTok{data.frame}\NormalTok{(}\DataTypeTok{method =} \StringTok{"Criterion lm"}\NormalTok{, lm\_validity\_practical\_criterion}\OperatorTok{$}\NormalTok{estimators[}\DecValTok{1}\OperatorTok{:}\DecValTok{3}\NormalTok{, ]),}
  \KeywordTok{data.frame}\NormalTok{(}\DataTypeTok{method =} \StringTok{"Criterion olp"}\NormalTok{, olp\_validity\_practical\_criterion}\OperatorTok{$}\NormalTok{estimators[}\DecValTok{1}\OperatorTok{:}\DecValTok{3}\NormalTok{, ])}
\NormalTok{)}

\NormalTok{practical\_estimators}\OperatorTok{$}\NormalTok{method <{-}}\StringTok{ }\KeywordTok{factor}\NormalTok{(}
\NormalTok{  practical\_estimators}\OperatorTok{$}\NormalTok{method,}
...
\NormalTok{practical\_estimators}\OperatorTok{$}\NormalTok{estimator <{-}}\StringTok{ }\KeywordTok{factor}\NormalTok{(}
\NormalTok{  practical\_estimators}\OperatorTok{$}\NormalTok{estimator,}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{simulation\_df <{-}}\StringTok{ }\KeywordTok{expand.grid}\NormalTok{(}
  \DataTypeTok{simulation =} \KeywordTok{seq}\NormalTok{(}\DecValTok{1}\NormalTok{, }\DecValTok{500}\NormalTok{),}
  \DataTypeTok{criterion\_random\_error =} \KeywordTok{seq}\NormalTok{(}\DecValTok{0}\NormalTok{, }\DecValTok{2} \OperatorTok{*}\StringTok{ }\NormalTok{practical\_random, }\DataTypeTok{length.out =} \DecValTok{10}\NormalTok{)}
\NormalTok{)}

\NormalTok{simulation\_df <{-}}\StringTok{ }\NormalTok{simulation\_df }\OperatorTok{\%>\%}
\StringTok{  }\KeywordTok{pmap\_dfr}\NormalTok{(}\ControlFlowTok{function}\NormalTok{(...) \{}
\NormalTok{    current <{-}}\StringTok{ }\KeywordTok{tibble}\NormalTok{(...)}

\NormalTok{    agreement\_data <{-}}\StringTok{ }\KeywordTok{tibble}\NormalTok{(}
      \DataTypeTok{True\_score =} \KeywordTok{rnorm}\NormalTok{(n\_subjects, }\DecValTok{45}\NormalTok{, }\DecValTok{5}\NormalTok{),}
      \DataTypeTok{Criterion\_score.trial1 =} \DecValTok{0} \OperatorTok{+}\StringTok{ }\NormalTok{(True\_score }\OperatorTok{*}\StringTok{ }\DecValTok{1}\NormalTok{) }\OperatorTok{+}\StringTok{ }\KeywordTok{rnorm}\NormalTok{(n\_subjects, }\DecValTok{0}\NormalTok{, current}\OperatorTok{$}\NormalTok{criterion\_random\_error),}
      \DataTypeTok{Criterion\_score.trial2 =} \DecValTok{0} \OperatorTok{+}\StringTok{ }\NormalTok{(True\_score }\OperatorTok{*}\StringTok{ }\DecValTok{1}\NormalTok{) }\OperatorTok{+}\StringTok{ }\KeywordTok{rnorm}\NormalTok{(n\_subjects, }\DecValTok{0}\NormalTok{, current}\OperatorTok{$}\NormalTok{criterion\_random\_error),}
      \DataTypeTok{Practical\_score.trial1 =}\NormalTok{ practical\_fixed }\OperatorTok{+}\StringTok{ }\NormalTok{(True\_score }\OperatorTok{*}\StringTok{ }\NormalTok{practical\_proportional) }\OperatorTok{+}\StringTok{ }\KeywordTok{rnorm}\NormalTok{(n\_subjects, }\DecValTok{0}\NormalTok{, practical\_random),}
      \DataTypeTok{Practical\_score.trial2 =}\NormalTok{ practical\_fixed }\OperatorTok{+}\StringTok{ }\NormalTok{(True\_score }\OperatorTok{*}\StringTok{ }\NormalTok{practical\_proportional) }\OperatorTok{+}\StringTok{ }\KeywordTok{rnorm}\NormalTok{(n\_subjects, }\DecValTok{0}\NormalTok{, practical\_random)}
\NormalTok{    )}
...
\NormalTok{  lm\_true <{-}}\StringTok{ }\KeywordTok{lm\_method}\NormalTok{(}
    \DataTypeTok{data =}\NormalTok{ data,}
    \DataTypeTok{criterion =} \StringTok{"Practical\_score.trial1"}\NormalTok{,}
    \DataTypeTok{practical =} \StringTok{"True\_score"}\NormalTok{,}
    \DataTypeTok{SESOI\_lower =} \OtherTok{NA}\NormalTok{,}
    \DataTypeTok{SESOI\_upper =} \OtherTok{NA}
\NormalTok{  )}

\NormalTok{  lm\_criterion <{-}}\StringTok{ }\KeywordTok{lm\_method}\NormalTok{(}
    \DataTypeTok{data =}\NormalTok{ data,}
    \DataTypeTok{criterion =} \StringTok{"Practical\_score.trial1"}\NormalTok{,}
    \DataTypeTok{practical =} \StringTok{"Criterion\_score.trial1"}\NormalTok{,}
    \DataTypeTok{SESOI\_lower =} \OtherTok{NA}\NormalTok{,}
...
\NormalTok{  olp\_criterion <{-}}\StringTok{ }\KeywordTok{olp\_method}\NormalTok{(}
    \DataTypeTok{data =}\NormalTok{ data,}
    \DataTypeTok{criterion =} \StringTok{"Practical\_score.trial1"}\NormalTok{,}
    \DataTypeTok{practical =} \StringTok{"Criterion\_score.trial1"}\NormalTok{,}
    \DataTypeTok{SESOI\_lower =} \OtherTok{NA}\NormalTok{,}
...
\NormalTok{  )}
  ...
  \KeywordTok{data.frame}\NormalTok{(}
    \DataTypeTok{simulation =}\NormalTok{ data}\OperatorTok{$}\NormalTok{simulation[}\DecValTok{1}\NormalTok{],}
    \DataTypeTok{criterion\_random\_error =}\NormalTok{ data}\OperatorTok{$}\NormalTok{criterion\_random\_error[}\DecValTok{1}\NormalTok{],}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{simulation\_results\_long <{-}}\StringTok{ }\KeywordTok{gather}\NormalTok{(simulation\_results, }\StringTok{"key"}\NormalTok{, }\StringTok{"value"}\NormalTok{, }\OperatorTok{{-}}\NormalTok{(}\DecValTok{1}\OperatorTok{:}\DecValTok{3}\NormalTok{))}

\CommentTok{\# Join the true DGP values for plotting}
\NormalTok{simulation\_results\_long <{-}}\StringTok{ }\KeywordTok{left\_join}\NormalTok{(}
\NormalTok{  simulation\_results\_long,}
  \KeywordTok{data.frame}\NormalTok{(}
    \DataTypeTok{key =} \KeywordTok{c}\NormalTok{(}\StringTok{"Intercept"}\NormalTok{, }\StringTok{"Slope"}\NormalTok{, }\StringTok{"RSE"}\NormalTok{),}
    \DataTypeTok{DGP =} \KeywordTok{c}\NormalTok{(practical\_fixed, practical\_proportional, practical\_random)}
\NormalTok{  ),}
  \DataTypeTok{by =} \StringTok{"key"}
\NormalTok{)}

\NormalTok{simulation\_results\_long}\OperatorTok{$}\NormalTok{key <{-}}\StringTok{ }\KeywordTok{factor}\NormalTok{(}
\NormalTok{  simulation\_results\_long}\OperatorTok{$}\NormalTok{key,}
  \DataTypeTok{levels =} \KeywordTok{c}\NormalTok{(}\StringTok{"Intercept"}\NormalTok{, }\StringTok{"Slope"}\NormalTok{, }\StringTok{"RSE"}\NormalTok{)}
\NormalTok{)}

\NormalTok{simulation\_results\_long}\OperatorTok{$}\NormalTok{method <{-}}\StringTok{ }\KeywordTok{factor}\NormalTok{(}
\NormalTok{  simulation\_results\_long}\OperatorTok{$}\NormalTok{method,}
...
\NormalTok{simulation\_results\_long\_avg <{-}}\StringTok{ }\NormalTok{simulation\_results\_long }\OperatorTok{\%>\%}
\StringTok{  }\KeywordTok{group\_by}\NormalTok{(method, criterion\_random\_error, key) }\OperatorTok{\%>\%}
\StringTok{  }\KeywordTok{summarise}\NormalTok{(}
    \DataTypeTok{mean =} \KeywordTok{mean}\NormalTok{(value),}
    \DataTypeTok{upper =}\NormalTok{ mean }\OperatorTok{+}\StringTok{ }\NormalTok{(}\KeywordTok{sd}\NormalTok{(value)),}
    \DataTypeTok{lower =}\NormalTok{ mean }\OperatorTok{{-}}\StringTok{ }\NormalTok{(}\KeywordTok{sd}\NormalTok{(value))}
\NormalTok{  )}
...
\NormalTok{  )}
  ...
  \KeywordTok{data.frame}\NormalTok{(}
    ...
    \DataTypeTok{method =} \KeywordTok{c}\NormalTok{(}\StringTok{"True lm"}\NormalTok{, }\StringTok{"Criterion lm"}\NormalTok{, }\StringTok{"Criterion olp"}\NormalTok{),}
    \DataTypeTok{Intercept =} \KeywordTok{c}\NormalTok{(lm\_true[}\DecValTok{1}\NormalTok{], lm\_criterion[}\DecValTok{1}\NormalTok{], olp\_criterion[}\DecValTok{1}\NormalTok{]),}
    \DataTypeTok{Slope =} \KeywordTok{c}\NormalTok{(}
\NormalTok{      lm\_true[}\DecValTok{2}\NormalTok{],}
\NormalTok{      lm\_criterion[}\DecValTok{2}\NormalTok{] }\OperatorTok{*}\StringTok{ }\NormalTok{slope\_adj,}
\NormalTok{      olp\_criterion[}\DecValTok{2}\NormalTok{] }\OperatorTok{*}\StringTok{ }\NormalTok{slope\_adj}
\NormalTok{      ),}
    \DataTypeTok{RSE =} \KeywordTok{c}\NormalTok{(}
\NormalTok{      lm\_true[}\DecValTok{3}\NormalTok{],}
...
\CommentTok{\#> 3          1                  0     Criterion olp    2.83    1.09 0.952}
\CommentTok{\#> 4          1                  0.222 True lm         {-}0.0301  1.14 1.19 }
\CommentTok{\#> 5          1                  0.222 Criterion lm    {-}0.717   1.16 1.13 }
\CommentTok{\#> 6          1                  0.222 Criterion olp   {-}1.38    1.17 1.13}
\end{Highlighting}
\end{Shaded}
...
\begin{Highlighting}[]
\NormalTok{bmbstats}\OperatorTok{::}\KeywordTok{plot\_pair\_lm}\NormalTok{(}
  \DataTypeTok{predictor =}\NormalTok{ agreement\_data}\OperatorTok{$}\NormalTok{Practical\_score.trial1,}
  \DataTypeTok{outcome =}\NormalTok{ agreement\_data}\OperatorTok{$}\NormalTok{Criterion\_score.trial1,}
  \DataTypeTok{predictor\_label =} \StringTok{"Practical Score"}\NormalTok{,}
  \DataTypeTok{outcome\_label =} \StringTok{"Criterion Score"}\NormalTok{,}
  \DataTypeTok{SESOI\_lower =} \FloatTok{{-}2.5}\NormalTok{,}
  \DataTypeTok{SESOI\_upper =} \FloatTok{2.5}
\NormalTok{)}
...
\NormalTok{  )}
  ...
  \KeywordTok{data.frame}\NormalTok{(}
    \DataTypeTok{simulation =}\NormalTok{ data}\OperatorTok{$}\NormalTok{simulation[}\DecValTok{1}\NormalTok{],}
    \DataTypeTok{criterion\_random\_error =}\NormalTok{ data}\OperatorTok{$}\NormalTok{criterion\_random\_error[}\DecValTok{1}\NormalTok{],}
    \DataTypeTok{method =} \KeywordTok{c}\NormalTok{(}\StringTok{"True lm"}\NormalTok{, }\StringTok{"Criterion lm"}\NormalTok{, }\StringTok{"Criterion olp"}\NormalTok{,  }\StringTok{"Adjusted lm"}\NormalTok{, }\StringTok{"Adjusted olp"}\NormalTok{),}
    \DataTypeTok{Intercept =} \KeywordTok{c}\NormalTok{(lm\_true[}\DecValTok{1}\NormalTok{], lm\_criterion[}\DecValTok{1}\NormalTok{], olp\_criterion[}\DecValTok{1}\NormalTok{], lm\_criterion[}\DecValTok{1}\NormalTok{], olp\_criterion[}\DecValTok{1}\NormalTok{]),}
    \DataTypeTok{Slope =} \KeywordTok{c}\NormalTok{(lm\_true[}\DecValTok{2}\NormalTok{], lm\_criterion[}\DecValTok{2}\NormalTok{], olp\_criterion[}\DecValTok{2}\NormalTok{], lm\_criterion[}\DecValTok{2}\NormalTok{], olp\_criterion[}\DecValTok{2}\NormalTok{]),}
    \DataTypeTok{RSE =} \KeywordTok{c}\NormalTok{(}
\NormalTok{      lm\_true[}\DecValTok{3}\NormalTok{],}
\NormalTok{      lm\_criterion[}\DecValTok{3}\NormalTok{],}
\NormalTok{      olp\_criterion[}\DecValTok{3}\NormalTok{],}
...
\NormalTok{simulation\_results\_long}\OperatorTok{$}\NormalTok{method <{-}}\StringTok{ }\KeywordTok{factor}\NormalTok{(}
\NormalTok{  simulation\_results\_long}\OperatorTok{$}\NormalTok{method,}
  \DataTypeTok{levels =} \KeywordTok{c}\NormalTok{(}\StringTok{"True lm"}\NormalTok{, }\StringTok{"Criterion lm"}\NormalTok{, }\StringTok{"Criterion olp"}\NormalTok{, }\StringTok{"Adjusted lm"}\NormalTok{, }\StringTok{"Adjusted olp"}\NormalTok{)}
\NormalTok{)}
...
\begin{Highlighting}[]
\NormalTok{bmbstats}\OperatorTok{::}\KeywordTok{plot\_pair\_BA}\NormalTok{(}
  \DataTypeTok{predictor =}\NormalTok{ agreement\_data}\OperatorTok{$}\NormalTok{Criterion\_score.trial2,}
  \DataTypeTok{outcome =}\NormalTok{ agreement\_data}\OperatorTok{$}\NormalTok{Criterion\_score.trial1,}
  \DataTypeTok{predictor\_label =} \StringTok{"Criterion Score Trial1"}\NormalTok{,}
  \DataTypeTok{outcome\_label =} \StringTok{"Criterion Score Trial2"}\NormalTok{,}
  \DataTypeTok{SESOI\_lower =} \FloatTok{{-}2.5}\NormalTok{,}
  \DataTypeTok{SESOI\_upper =} \FloatTok{2.5}
\NormalTok{)}
\end{Highlighting}
...
\NormalTok{)}
  ...
  \KeywordTok{data.frame}\NormalTok{(}
    \DataTypeTok{simulation =}\NormalTok{ data}\OperatorTok{$}\NormalTok{simulation[}\DecValTok{1}\NormalTok{],}
    \DataTypeTok{criterion\_random\_error =}\NormalTok{ data}\OperatorTok{$}\NormalTok{criterion\_random\_error[}\DecValTok{1}\NormalTok{],}
    \DataTypeTok{method =} \KeywordTok{c}\NormalTok{(}\StringTok{"diff"}\NormalTok{, }\StringTok{"lm"}\NormalTok{, }\StringTok{"olp"}\NormalTok{),}
    \DataTypeTok{Intercept =} \KeywordTok{c}\NormalTok{(diff\_reporoducibility[}\DecValTok{1}\NormalTok{], lm\_reporoducibility[}\DecValTok{1}\NormalTok{], olp\_reporoducibility[}\DecValTok{1}\NormalTok{]),}
    ...
    \DataTypeTok{TE =} \KeywordTok{c}\NormalTok{(diff\_reporoducibility[}\DecValTok{2}\NormalTok{], lm\_reporoducibility[}\DecValTok{3}\NormalTok{], olp\_reporoducibility[}\DecValTok{3}\NormalTok{]) }\OperatorTok{/}\StringTok{ }\KeywordTok{sqrt}\NormalTok{(}\DecValTok{2}\NormalTok{)}
\NormalTok{  )}
\NormalTok{\}}
...
\NormalTok{  simulation\_results\_long,}
  \KeywordTok{data.frame}\NormalTok{(}
    \DataTypeTok{key =} \KeywordTok{c}\NormalTok{(}\StringTok{"Intercept"}\NormalTok{, }\StringTok{"Slope"}\NormalTok{, }\StringTok{"TE"}\NormalTok{),}
    \DataTypeTok{DGP =} \KeywordTok{c}\NormalTok{(}\DecValTok{0}\NormalTok{, }\DecValTok{1}\NormalTok{, }\OtherTok{NA}\NormalTok{)}
\NormalTok{  ),}
  \DataTypeTok{by =} \StringTok{"key"}
\NormalTok{)}
...
\begin{Highlighting}[]
\NormalTok{bmbstats}\OperatorTok{::}\KeywordTok{plot\_pair\_OLP}\NormalTok{(}
  \DataTypeTok{predictor =}\NormalTok{ agreement\_data}\OperatorTok{$}\NormalTok{Practical\_score.trial2,}
  \DataTypeTok{outcome =}\NormalTok{ agreement\_data}\OperatorTok{$}\NormalTok{Practical\_score.trial1,}
  \DataTypeTok{predictor\_label =} \StringTok{"Practical Score Trial1"}\NormalTok{,}
  \DataTypeTok{outcome\_label =} \StringTok{"Practical Score Trial2"}\NormalTok{,}
...
\begin{Highlighting}[]
\NormalTok{bmbstats}\OperatorTok{::}\KeywordTok{plot\_pair\_BA}\NormalTok{(}
  \DataTypeTok{predictor =}\NormalTok{ reproducibility\_data}\OperatorTok{$}\NormalTok{Criterion\_score\_B,}
  \DataTypeTok{outcome =}\NormalTok{ reproducibility\_data}\OperatorTok{$}\NormalTok{Criterion\_score\_A,}
  \DataTypeTok{predictor\_label =} \StringTok{"Unit B"}\NormalTok{,}
  \DataTypeTok{outcome\_label =} \StringTok{"Unit A"}\NormalTok{,}
  \DataTypeTok{SESOI\_lower =} \FloatTok{{-}2.5}\NormalTok{,}
  \DataTypeTok{SESOI\_upper =} \FloatTok{2.5}
\NormalTok{)}
\end{Highlighting}
...
\begin{Highlighting}[]
\NormalTok{bmbstats}\OperatorTok{::}\KeywordTok{plot\_pair\_BA}\NormalTok{(}
  \DataTypeTok{predictor =}\NormalTok{ reproducibility\_data}\OperatorTok{$}\NormalTok{Criterion\_score\_C,}
  \DataTypeTok{outcome =}\NormalTok{ reproducibility\_data}\OperatorTok{$}\NormalTok{Criterion\_score\_A,}
  \DataTypeTok{predictor\_label =} \StringTok{"Unit C"}\NormalTok{,}
  \DataTypeTok{outcome\_label =} \StringTok{"Unit A"}\NormalTok{,}
  \DataTypeTok{SESOI\_lower =} \FloatTok{{-}2.5}\NormalTok{,}
  \DataTypeTok{SESOI\_upper =} \FloatTok{2.5}
\NormalTok{)}
...
\begin{Highlighting}[]
\NormalTok{bmbstats}\OperatorTok{::}\KeywordTok{plot\_pair\_OLP}\NormalTok{(}
  \DataTypeTok{predictor =}\NormalTok{ repeatability\_data}\OperatorTok{$}\NormalTok{Manifested\_score.Pre,}
  \DataTypeTok{outcome =}\NormalTok{ repeatability\_data}\OperatorTok{$}\NormalTok{Manifested\_score.Post,}
  \DataTypeTok{predictor\_label =} \StringTok{"Manifested Score Pre{-}test"}\NormalTok{,}
  \DataTypeTok{outcome\_label =} \StringTok{"Manifested Score Post{-}test"}\NormalTok{,}
  \DataTypeTok{SESOI\_lower =} \FloatTok{{-}2.5}\NormalTok{,}
  \DataTypeTok{SESOI\_upper =} \FloatTok{2.5}
\NormalTok{)}
\end{Highlighting}
...
\begin{Highlighting}[]
\NormalTok{bmbstats}\OperatorTok{::}\KeywordTok{plot\_pair\_OLP}\NormalTok{(}
  \DataTypeTok{predictor =}\NormalTok{ repeatability\_data}\OperatorTok{$}\NormalTok{Measured\_score.Pre,}
  \DataTypeTok{outcome =}\NormalTok{ repeatability\_data}\OperatorTok{$}\NormalTok{Measured\_score.Post,}
  \DataTypeTok{predictor\_label =} \StringTok{"Measured Score Pre{-}test"}\NormalTok{,}
  \DataTypeTok{outcome\_label =} \StringTok{"Measured Score Post{-}test"}\NormalTok{,}
  \DataTypeTok{SESOI\_lower =} \OperatorTok{{-}}\StringTok{ }\FloatTok{2.5} \OperatorTok{*}\StringTok{ }\NormalTok{practical\_proportional,}
  \DataTypeTok{SESOI\_upper =} \FloatTok{2.5} \OperatorTok{*}\StringTok{ }\NormalTok{practical\_proportional}
\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{bmbstats}\OperatorTok{::}\KeywordTok{plot\_pair\_changes}\NormalTok{(}
  \DataTypeTok{group\_a =}\NormalTok{ RCT\_data}\OperatorTok{$}\NormalTok{Measured\_score.Pre,}
  \DataTypeTok{group\_b =}\NormalTok{ RCT\_data}\OperatorTok{$}\NormalTok{Measured\_score.Post,}
  \DataTypeTok{group\_a\_label =} \StringTok{"Measured Pre{-}test"}\NormalTok{,}
  \DataTypeTok{group\_b\_label =} \StringTok{"Measured Post{-}test"}\NormalTok{,}
  \DataTypeTok{SESOI\_lower =} \DecValTok{{-}5}\NormalTok{,}
  \DataTypeTok{SESOI\_upper =} \DecValTok{5}
\NormalTok{)}
\end{Highlighting}
...
\CommentTok{\#>    id     group pre\_test post\_test     change      SDC change\_lower}
\CommentTok{\#> 11  1 Treatment 52.87665  53.06613  0.1894841 3.222294   {-}3.0328104}
\CommentTok{\#> 12  2 Treatment 48.86917  51.26538  2.3962116 3.222294   {-}0.8260828}
\CommentTok{\#> 13  3 Treatment 41.83908  39.31947 {-}2.5196029 3.222294   {-}5.7418974}
\CommentTok{\#> 14  4 Treatment 43.14467  40.80646 {-}2.3382079 3.222294   {-}5.5605023}
\CommentTok{\#> 15  5 Treatment 32.93471  33.26669  0.3319806 3.222294   {-}2.8903138}
\CommentTok{\#> 16  6 Treatment 34.17358  33.61544 {-}0.5581425 3.222294   {-}3.7804369}
\CommentTok{\#>    change\_upper adjusted\_change adjusted\_change\_lower adjusted\_change\_upper}
\CommentTok{\#> 11    3.4117785       0.5746587            {-}2.6476357              3.796953}
\CommentTok{\#> 12    5.6185061       2.7813863            {-}0.4409082              6.003681}
\CommentTok{\#> 13    0.7026915      {-}2.1344283            {-}5.3567227              1.087866}
\CommentTok{\#> 14    0.8840866      {-}1.9530332            {-}5.1753277              1.269261}
\CommentTok{\#> 15    3.5542751       0.7171553            {-}2.5051392              3.939450}
\CommentTok{\#> 16    2.6641520      {-}0.1729678            {-}3.3952623              3.049327}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{RCT\_data}\OperatorTok{$}\NormalTok{Group\_num <{-}}\StringTok{ }\KeywordTok{ifelse}\NormalTok{(}
\NormalTok{  RCT\_data}\OperatorTok{$}\NormalTok{Group }\OperatorTok{==}\StringTok{ "Treatment"}\NormalTok{,}
...
\KeywordTok{ggplot}\NormalTok{(}
\NormalTok{  RCT\_data,}
  \KeywordTok{aes}\NormalTok{(}\DataTypeTok{x =}\NormalTok{ Group\_num, }\DataTypeTok{y =}\NormalTok{ Measured\_score.Change)}
\NormalTok{) }\OperatorTok{+}
\StringTok{  }\KeywordTok{theme\_cowplot}\NormalTok{(}\DecValTok{8}\NormalTok{) }\OperatorTok{+}
\StringTok{  }\KeywordTok{geom\_jitter}\NormalTok{(}\KeywordTok{aes}\NormalTok{(}\DataTypeTok{color =}\NormalTok{ Group), }\DataTypeTok{width =} \FloatTok{0.2}\NormalTok{) }\OperatorTok{+}
\StringTok{  }\KeywordTok{geom\_smooth}\NormalTok{(}\DataTypeTok{method =} \StringTok{"lm"}\NormalTok{, }\DataTypeTok{formula =}\NormalTok{ y }\OperatorTok{\textasciitilde{}}\StringTok{ }\NormalTok{x, }\DataTypeTok{se =} \OtherTok{TRUE}\NormalTok{) }\OperatorTok{+}
...
\StringTok{  }\KeywordTok{scale\_x\_continuous}\NormalTok{(}
    \DataTypeTok{name =} \StringTok{"Group"}\NormalTok{,}
    \DataTypeTok{breaks =} \KeywordTok{c}\NormalTok{(}\DecValTok{0}\NormalTok{, }\DecValTok{1}\NormalTok{),}
    \DataTypeTok{labels =} \KeywordTok{c}\NormalTok{(}\StringTok{"Control"}\NormalTok{, }\StringTok{"Treatment"}\NormalTok{)}
\NormalTok{  )}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{RCT\_data}\OperatorTok{$}\NormalTok{.pred <{-}}\StringTok{ }\KeywordTok{predict}\NormalTok{(}
\NormalTok{  model2,}
  \DataTypeTok{newdata =}\NormalTok{ RCT\_data}
\NormalTok{)}
...
\StringTok{  }\KeywordTok{theme\_cowplot}\NormalTok{(}\DecValTok{8}\NormalTok{) }\OperatorTok{+}
\StringTok{  }\KeywordTok{geom\_point}\NormalTok{(}\DataTypeTok{alpha =} \FloatTok{0.8}\NormalTok{) }\OperatorTok{+}
\StringTok{  }\KeywordTok{geom\_line}\NormalTok{(}\KeywordTok{aes}\NormalTok{(}\DataTypeTok{y =}\NormalTok{ .pred)) }\OperatorTok{+}
\StringTok{  }\KeywordTok{scale\_color\_manual}\NormalTok{(}\DataTypeTok{values =} \KeywordTok{c}\NormalTok{(}\DataTypeTok{Treatment =} \StringTok{"\#FAA43A"}\NormalTok{, }\DataTypeTok{Control =} \StringTok{"\#5DA5DA"}\NormalTok{)) }\OperatorTok{+}
\StringTok{  }\KeywordTok{scale\_fill\_manual}\NormalTok{(}\DataTypeTok{values =} \KeywordTok{c}\NormalTok{(}\DataTypeTok{Treatment =} \StringTok{"\#FAA43A"}\NormalTok{, }\DataTypeTok{Control =} \StringTok{"\#5DA5DA"}\NormalTok{))}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{compare\_methods <{-}}\StringTok{ }\KeywordTok{rbind}\NormalTok{(}
  \KeywordTok{data.frame}\NormalTok{(}\DataTypeTok{method =} \StringTok{"differences"}\NormalTok{, simple\_RCT}\OperatorTok{$}\NormalTok{estimators),}
  \KeywordTok{data.frame}\NormalTok{(}\DataTypeTok{method =} \StringTok{"linear regression"}\NormalTok{, regression\_RCT}\OperatorTok{$}\NormalTok{estimators)}
\NormalTok{)}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{model3 <{-}}\StringTok{ }\KeywordTok{cv\_model}\NormalTok{(}
\NormalTok{  Measured\_score.Post }\OperatorTok{\textasciitilde{}}\StringTok{ }\NormalTok{Measured\_score.Pre }\OperatorTok{+}\StringTok{ }\NormalTok{Group,}
\NormalTok{  RCT\_data,}
  \DataTypeTok{SESOI\_lower =} \DecValTok{{-}5}\NormalTok{,}
  \DataTypeTok{SESOI\_upper =} \DecValTok{5}\NormalTok{,}
  \DataTypeTok{control =} \KeywordTok{model\_control}\NormalTok{(}
    ...
    \DataTypeTok{cv\_repeats =} \DecValTok{10}\NormalTok{,}
    \DataTypeTok{cv\_strata =} \KeywordTok{factor}\NormalTok{(RCT\_data}\OperatorTok{$}\NormalTok{Group)}
\NormalTok{  )}
\NormalTok{)}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{prediction\_RCT <{-}}\StringTok{ }\KeywordTok{RCT\_predict}\NormalTok{(}
\NormalTok{  model3,}
  \DataTypeTok{new\_data =}\NormalTok{ RCT\_data,}
  \DataTypeTok{outcome =} \StringTok{"Measured\_score.Post"}\NormalTok{,}
  \DataTypeTok{group =} \StringTok{"Group"}\NormalTok{,}
  \DataTypeTok{treatment\_label =} \StringTok{"Treatment"}\NormalTok{,}
  \DataTypeTok{control\_label =} \StringTok{"Control"}\NormalTok{,}
...
\CommentTok{\#>   Athlete Group True\_score.Pre Treatment\_effect Non\_treatment\_e\textasciitilde{}}
\CommentTok{\#>   <chr>   <fct>          <dbl>            <dbl>            <dbl>}
\CommentTok{\#> 1 Athlet\textasciitilde{} Trea\textasciitilde{}           47.4           {-}3.24              1.17}
\CommentTok{\#> 2 Athlet\textasciitilde{} Cont\textasciitilde{}           44.4            3.43              4.57}
\CommentTok{\#> 3 Athlet\textasciitilde{} Trea\textasciitilde{}           50.5            4.09              2.74}
\CommentTok{\#> 4 Athlet\textasciitilde{} Cont\textasciitilde{}           37.8           12.4               2.15}
\CommentTok{\#> 5 Athlet\textasciitilde{} Trea\textasciitilde{}           50.7            0.671             1.87}
\CommentTok{\#> 6 Athlet\textasciitilde{} Cont\textasciitilde{}           42.7           12.6               2.78}
\CommentTok{\#> \# ... with 8 more variables: True\_score.Change <dbl>, True\_score.Post <dbl>,}
\CommentTok{\#> \#   Manifested\_score.Pre <dbl>, Manifested\_score.Post <dbl>,}
\CommentTok{\#> \#   Manifested\_score.Change <dbl>, Measured\_score.Pre <dbl>,}
\CommentTok{\#> \#   Measured\_score.Post <dbl>, Measured\_score.Change <dbl>}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{model5 <{-}}\StringTok{ }\KeywordTok{cv\_model}\NormalTok{(}
\NormalTok{  Measured\_score.Post }\OperatorTok{\textasciitilde{}}\StringTok{ }\NormalTok{Measured\_score.Pre }\OperatorTok{+}\StringTok{ }\NormalTok{Group,}
\NormalTok{  RCT\_data,}
  \DataTypeTok{SESOI\_lower =} \DecValTok{{-}5}\NormalTok{,}
  \DataTypeTok{SESOI\_upper =} \DecValTok{5}\NormalTok{,}
...
\begin{Highlighting}[]
\NormalTok{SD\_summary <{-}}\StringTok{ }\NormalTok{RCT\_data }\OperatorTok{\%>\%}
\StringTok{  }\KeywordTok{mutate}\NormalTok{(}\DataTypeTok{.resid =} \KeywordTok{residuals}\NormalTok{(model6)) }\OperatorTok{\%>\%}
\StringTok{  }\KeywordTok{group\_by}\NormalTok{(Group) }\OperatorTok{\%>\%}
\StringTok{  }\KeywordTok{summarise}\NormalTok{(}\StringTok{\textasciigrave{}}\DataTypeTok{Residual SD}\StringTok{\textasciigrave{}}\NormalTok{ =}\StringTok{ }\KeywordTok{sd}\NormalTok{(.resid))}
...
\begin{Highlighting}[]
\NormalTok{SD\_summary <{-}}\StringTok{ }\NormalTok{RCT\_data }\OperatorTok{\%>\%}
\StringTok{  }\KeywordTok{mutate}\NormalTok{(}\DataTypeTok{.resid =} \KeywordTok{residuals}\NormalTok{(model7)) }\OperatorTok{\%>\%}
\StringTok{  }\KeywordTok{group\_by}\NormalTok{(Group) }\OperatorTok{\%>\%}
\StringTok{  }\KeywordTok{summarise}\NormalTok{(}\StringTok{\textasciigrave{}}\DataTypeTok{Residual SD}\StringTok{\textasciigrave{}}\NormalTok{ =}\StringTok{ }\KeywordTok{sd}\NormalTok{(.resid))}
...
\begin{Highlighting}[]
\NormalTok{SD\_summary <{-}}\StringTok{ }\NormalTok{RCT\_data }\OperatorTok{\%>\%}
\StringTok{  }\KeywordTok{mutate}\NormalTok{(}\DataTypeTok{.resid =} \KeywordTok{residuals}\NormalTok{(model8)) }\OperatorTok{\%>\%}
\StringTok{  }\KeywordTok{group\_by}\NormalTok{(Group) }\OperatorTok{\%>\%}
\StringTok{  }\KeywordTok{summarise}\NormalTok{(}\StringTok{\textasciigrave{}}\DataTypeTok{Residual SD}\StringTok{\textasciigrave{}}\NormalTok{ =}\StringTok{ }\KeywordTok{sd}\NormalTok{(.resid))}
...
\NormalTok{  model <{-}}\StringTok{ }\KeywordTok{cv\_model}\NormalTok{(}
\NormalTok{    formula,}
\NormalTok{    RCT\_data,}
    \DataTypeTok{SESOI\_lower =} \DecValTok{{-}5}\NormalTok{,}
    \DataTypeTok{SESOI\_upper =} \DecValTok{5}\NormalTok{,}
...
\NormalTok{  RCT <{-}}\StringTok{ }\KeywordTok{RCT\_predict}\NormalTok{(}
\NormalTok{    model,}
    \DataTypeTok{new\_data =}\NormalTok{ RCT\_data,}
    \DataTypeTok{outcome =} \StringTok{"Measured\_score.Post"}\NormalTok{,}
    \DataTypeTok{group =} \StringTok{"Group"}\NormalTok{,}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{model\_estimates <{-}}\StringTok{ }\KeywordTok{rbind}\NormalTok{(}
  \KeywordTok{data.frame}\NormalTok{(}
    \DataTypeTok{model =} \StringTok{"base"}\NormalTok{,}
    \DataTypeTok{pATE =}\NormalTok{ base\_model}\OperatorTok{$}\NormalTok{extra}\OperatorTok{$}\NormalTok{average\_treatment\_effect,}
    \DataTypeTok{pVTE =}\NormalTok{ base\_model}\OperatorTok{$}\NormalTok{extra}\OperatorTok{$}\NormalTok{variable\_treatment\_effect,}
    \DataTypeTok{RTE =}\NormalTok{  base\_model}\OperatorTok{$}\NormalTok{extra}\OperatorTok{$}\NormalTok{random\_treatment\_effect}
\NormalTok{  ),}
  \KeywordTok{data.frame}\NormalTok{(}
    \DataTypeTok{model =} \StringTok{"pre{-}test"}\NormalTok{,}
    \DataTypeTok{pATE =}\NormalTok{ pre\_test\_model}\OperatorTok{$}\NormalTok{extra}\OperatorTok{$}\NormalTok{average\_treatment\_effect,}
...
\NormalTok{  ),}
  \KeywordTok{data.frame}\NormalTok{(}
    \DataTypeTok{model =} \StringTok{"covariate"}\NormalTok{,}
    \DataTypeTok{pATE =}\NormalTok{ covariate\_model}\OperatorTok{$}\NormalTok{extra}\OperatorTok{$}\NormalTok{average\_treatment\_effect,}
...
\NormalTok{  ),}
    \KeywordTok{data.frame}\NormalTok{(}
    \DataTypeTok{model =} \StringTok{"interaction"}\NormalTok{,}
    \DataTypeTok{pATE =}\NormalTok{ interaction\_model}\OperatorTok{$}\NormalTok{extra}\OperatorTok{$}\NormalTok{average\_treatment\_effect,}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{model\_performace <{-}}\StringTok{ }\KeywordTok{rbind}\NormalTok{(}
  \KeywordTok{data.frame}\NormalTok{(}
    \DataTypeTok{model =} \StringTok{"base"}\NormalTok{,}
\NormalTok{    base\_model}\OperatorTok{$}\NormalTok{cross\_validation}\OperatorTok{$}\NormalTok{performance}\OperatorTok{$}\NormalTok{summary}\OperatorTok{$}\NormalTok{training}
\NormalTok{  ),}
  \KeywordTok{data.frame}\NormalTok{(}
    \DataTypeTok{model =} \StringTok{"pre{-}test"}\NormalTok{,}
\NormalTok{    pre\_test\_model}\OperatorTok{$}\NormalTok{cross\_validation}\OperatorTok{$}\NormalTok{performance}\OperatorTok{$}\NormalTok{summary}\OperatorTok{$}\NormalTok{training}
\NormalTok{  ),}
  \KeywordTok{data.frame}\NormalTok{(}
    \DataTypeTok{model =} \StringTok{"covariate"}\NormalTok{,}
\NormalTok{    covariate\_model}\OperatorTok{$}\NormalTok{cross\_validation}\OperatorTok{$}\NormalTok{performance}\OperatorTok{$}\NormalTok{summary}\OperatorTok{$}\NormalTok{training}
\NormalTok{  ),}
    \KeywordTok{data.frame}\NormalTok{(}
    \DataTypeTok{model =} \StringTok{"interaction"}\NormalTok{,}
\NormalTok{    interaction\_model}\OperatorTok{$}\NormalTok{cross\_validation}\OperatorTok{$}\NormalTok{performance}\OperatorTok{$}\NormalTok{summary}\OperatorTok{$}\NormalTok{training}
\NormalTok{  )}
\NormalTok{)}

\NormalTok{model\_performace}\OperatorTok{$}\NormalTok{model <{-}}\StringTok{ }\KeywordTok{factor}\NormalTok{(}
\NormalTok{  model\_performace}\OperatorTok{$}\NormalTok{model,}
...
\NormalTok{model\_performace <{-}}\StringTok{ }\KeywordTok{rbind}\NormalTok{(}
  \KeywordTok{data.frame}\NormalTok{(}
    \DataTypeTok{model =} \StringTok{"base"}\NormalTok{,}
\NormalTok{    base\_model}\OperatorTok{$}\NormalTok{cross\_validation}\OperatorTok{$}\NormalTok{performance}\OperatorTok{$}\NormalTok{summary}\OperatorTok{$}\NormalTok{testing}
\NormalTok{  ),}
  \KeywordTok{data.frame}\NormalTok{(}
    \DataTypeTok{model =} \StringTok{"pre{-}test"}\NormalTok{,}
\NormalTok{    pre\_test\_model}\OperatorTok{$}\NormalTok{cross\_validation}\OperatorTok{$}\NormalTok{performance}\OperatorTok{$}\NormalTok{summary}\OperatorTok{$}\NormalTok{testing}
\NormalTok{  ),}
  \KeywordTok{data.frame}\NormalTok{(}
    \DataTypeTok{model =} \StringTok{"covariate"}\NormalTok{,}
\NormalTok{    covariate\_model}\OperatorTok{$}\NormalTok{cross\_validation}\OperatorTok{$}\NormalTok{performance}\OperatorTok{$}\NormalTok{summary}\OperatorTok{$}\NormalTok{testing}
\NormalTok{  ),}
    \KeywordTok{data.frame}\NormalTok{(}
    \DataTypeTok{model =} \StringTok{"interaction"}\NormalTok{,}
\NormalTok{    interaction\_model}\OperatorTok{$}\NormalTok{cross\_validation}\OperatorTok{$}\NormalTok{performance}\OperatorTok{$}\NormalTok{summary}\OperatorTok{$}\NormalTok{testing}
\NormalTok{  )}
\NormalTok{)}
...
\CommentTok{\# Plot}
\NormalTok{dose <{-}}\StringTok{ }\KeywordTok{ggplot}\NormalTok{(bike\_score, }\KeywordTok{aes}\NormalTok{(}\DataTypeTok{x =}\NormalTok{ Day, }\DataTypeTok{y =}\NormalTok{ BikeScore)) }\OperatorTok{+}
\StringTok{  }\KeywordTok{theme\_cowplot}\NormalTok{(}\DecValTok{10}\NormalTok{) }\OperatorTok{+}
...
\NormalTok{response <{-}}\StringTok{ }\KeywordTok{ggplot}\NormalTok{(bike\_score, }\KeywordTok{aes}\NormalTok{(}\DataTypeTok{x =}\NormalTok{ Day, }\DataTypeTok{y =}\NormalTok{ pred)) }\OperatorTok{+}
\StringTok{   }\KeywordTok{theme\_cowplot}\NormalTok{(}\DecValTok{10}\NormalTok{) }\OperatorTok{+}
\StringTok{   }\KeywordTok{geom\_line}\NormalTok{() }\OperatorTok{+}
\StringTok{   }\KeywordTok{geom\_point}\NormalTok{(}\KeywordTok{aes}\NormalTok{(}\DataTypeTok{y =}\NormalTok{ Test\_5min\_Power), }\DataTypeTok{color =} \StringTok{"red"}\NormalTok{) }\OperatorTok{+}
\StringTok{   }\KeywordTok{ylab}\NormalTok{(}\StringTok{"Test 5min Power"}\NormalTok{)}
...
\NormalTok{kimberley\_profile <{-}}\StringTok{ }\NormalTok{shorts}\OperatorTok{::}\KeywordTok{model\_using\_splits}\NormalTok{(}
  \DataTypeTok{distance =}\NormalTok{ kimberley\_data}\OperatorTok{$}\NormalTok{distance,}
  \DataTypeTok{time =}\NormalTok{ kimberley\_data}\OperatorTok{$}\NormalTok{time)  }

\CommentTok{\# Parameters}
\KeywordTok{unlist}\NormalTok{(kimberley\_profile}\OperatorTok{$}\NormalTok{parameters)}
\CommentTok{\#>        MSS        TAU        MAC       PMAX }
\CommentTok{\#>  8.5911421  0.8113282 10.5889855 22.7428698}

\CommentTok{\# Model performance/fit}
\KeywordTok{unlist}\NormalTok{(kimberley\_profile}\OperatorTok{$}\NormalTok{model\_fit)}
\CommentTok{\#>         RSE   R\_squared      minErr      maxErr        RMSE }
\CommentTok{\#>  0.03403413  0.99965531 {-}0.02699169  0.05293444  0.02778875}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{shorts}\OperatorTok{::}\KeywordTok{format\_splits}\NormalTok{(}
  \DataTypeTok{distance =}\NormalTok{ kimberley\_data}\OperatorTok{$}\NormalTok{distance,}
  \DataTypeTok{time =}\NormalTok{ kimberley\_data}\OperatorTok{$}\NormalTok{time)}
\CommentTok{\#>   split split\_distance\_start split\_distance\_stop split\_distance}
\CommentTok{\#> 1     1                    0                   5              5}
\CommentTok{\#> 2     2                    5                  10              5}
\CommentTok{\#> 3     3                   10                  15              5}
\CommentTok{\#> 4     4                   15                  20              5}
\CommentTok{\#> 5     5                   20                  30             10}
\CommentTok{\#> 6     6                   30                  40             10}
\CommentTok{\#>   split\_time\_start split\_time\_stop split\_time split\_mean\_velocity}
\CommentTok{\#> 1                0           1.158      1.158        4.317789....}
\CommentTok{\#> 2            1.158           1.893      0.735        6.802721....}
\CommentTok{\#> 3            1.893           2.541      0.648        7.716049....}
\CommentTok{\#> 4            2.541           3.149      0.608        8.223684....}
\CommentTok{\#> 5            3.149           4.313      1.164        8.591065....}
\CommentTok{\#> 6            4.313           5.444      1.131        8.841732....}
\end{Highlighting}
\end{Shaded}

Let's plot observed vs fitted split times. For this we can use \texttt{data} returned from \texttt{shorts::model\_using\_splits} since it contains \texttt{pred\_time} column, but we can also use \texttt{shorts:predict\_} family of functions.

\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{ggplot}\NormalTok{(kimberley\_profile}\OperatorTok{$}\NormalTok{data, }\KeywordTok{aes}\NormalTok{(}\DataTypeTok{x =}\NormalTok{ distance)) }\OperatorTok{+}
\StringTok{  }\KeywordTok{theme\_bw}\NormalTok{() }\OperatorTok{+}
\StringTok{  }\KeywordTok{geom\_point}\NormalTok{(}\KeywordTok{aes}\NormalTok{(}\DataTypeTok{y =}\NormalTok{ time)) }\OperatorTok{+}
\StringTok{  }\KeywordTok{geom\_line}\NormalTok{(}\KeywordTok{aes}\NormalTok{(}\DataTypeTok{y =}\NormalTok{ pred\_time)) }\OperatorTok{+}
\StringTok{  }\KeywordTok{xlab}\NormalTok{(}\StringTok{"Distance (m)"}\NormalTok{) }\OperatorTok{+}
\StringTok{  }\KeywordTok{ylab}\NormalTok{(}\StringTok{"Time (s)"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{shorts}\OperatorTok{::}\KeywordTok{find\_max\_power\_distance}\NormalTok{(}
\NormalTok{  kimberley\_profile}\OperatorTok{$}\NormalTok{parameters}\OperatorTok{$}\NormalTok{MSS,}
\NormalTok{  kimberley\_profile}\OperatorTok{$}\NormalTok{parameters}\OperatorTok{$}\NormalTok{TAU}
\NormalTok{)}
...
\NormalTok{shorts}\OperatorTok{::}\KeywordTok{find\_power\_critical\_distance}\NormalTok{(}
  \DataTypeTok{MSS =}\NormalTok{ kimberley\_profile}\OperatorTok{$}\NormalTok{parameters}\OperatorTok{$}\NormalTok{MSS,}
  \DataTypeTok{TAU =}\NormalTok{ kimberley\_profile}\OperatorTok{$}\NormalTok{parameters}\OperatorTok{$}\NormalTok{TAU,}
  \DataTypeTok{percent =} \FloatTok{0.5}
\NormalTok{)}
\CommentTok{\#> $lower}
...
\NormalTok{shorts}\OperatorTok{::}\KeywordTok{find\_acceleration\_critical\_distance}\NormalTok{(}
  \DataTypeTok{MSS =}\NormalTok{ kimberley\_profile}\OperatorTok{$}\NormalTok{parameters}\OperatorTok{$}\NormalTok{MSS,}
  \DataTypeTok{TAU =}\NormalTok{ kimberley\_profile}\OperatorTok{$}\NormalTok{parameters}\OperatorTok{$}\NormalTok{TAU,}
  \DataTypeTok{percent =} \FloatTok{0.5}
\NormalTok{)}
...
\NormalTok{shorts}\OperatorTok{::}\KeywordTok{find\_velocity\_critical\_distance}\NormalTok{(}
  \DataTypeTok{MSS =}\NormalTok{ kimberley\_profile}\OperatorTok{$}\NormalTok{parameters}\OperatorTok{$}\NormalTok{MSS,}
  \DataTypeTok{TAU =}\NormalTok{ kimberley\_profile}\OperatorTok{$}\NormalTok{parameters}\OperatorTok{$}\NormalTok{TAU,}
  \DataTypeTok{percent =} \FloatTok{0.95}
\NormalTok{)}
...
Each individual can be modeled separately, or we can perform \emph{non-linear mixed model} using \texttt{nlme} function from \emph{nlme} package (Pinheiro et al. \protect\hyperlink{ref-R-nlme}{2020}). This is done using \texttt{shorts::mixed\_model\_using\_splits}:

\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{mixed\_model <{-}}\StringTok{ }\NormalTok{shorts}\OperatorTok{::}\KeywordTok{mixed\_model\_using\_splits}\NormalTok{(}
  \DataTypeTok{data =}\NormalTok{ split\_times,}
  \DataTypeTok{distance =} \StringTok{"distance"}\NormalTok{,}
  \DataTypeTok{time =} \StringTok{"time"}\NormalTok{,}
  \DataTypeTok{athlete =} \StringTok{"athlete"}
\NormalTok{)}

\CommentTok{\# Parameters}
\NormalTok{mixed\_model}\OperatorTok{$}\NormalTok{parameters}
\CommentTok{\#> $fixed}
\CommentTok{\#>        MSS       TAU      MAC     PMAX}
\CommentTok{\#> 1 8.064911 0.6551988 12.30911 24.81796}
\CommentTok{\#> }
\CommentTok{\#> $random}
...
\CommentTok{\# Model performance/fit}
\KeywordTok{unlist}\NormalTok{(mixed\_model}\OperatorTok{$}\NormalTok{model\_fit)}
\CommentTok{\#>         RSE   R\_squared      minErr      maxErr        RMSE }
\CommentTok{\#>  0.02600213  0.99982036 {-}0.02934519  0.04964582  0.02139178}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{velocity\_over\_distance <{-}}\StringTok{ }\KeywordTok{merge}\NormalTok{(}
\NormalTok{    mixed\_model}\OperatorTok{$}\NormalTok{parameters}\OperatorTok{$}\NormalTok{random,}
...
\NormalTok{  shorts}\OperatorTok{::}\KeywordTok{predict\_velocity\_at\_distance}\NormalTok{(}
    \DataTypeTok{distance =}\NormalTok{ distance,}
    \DataTypeTok{MSS =}\NormalTok{ MSS,}
    \DataTypeTok{TAU =}\NormalTok{ TAU)}
\NormalTok{)}

\KeywordTok{ggplot}\NormalTok{(velocity\_over\_distance, }\KeywordTok{aes}\NormalTok{(}\DataTypeTok{x =}\NormalTok{ distance, }\DataTypeTok{y =}\NormalTok{ pred\_velocity, }\DataTypeTok{color =}\NormalTok{ athlete)) }\OperatorTok{+}
\StringTok{  }\KeywordTok{theme\_bw}\NormalTok{() }\OperatorTok{+}
\StringTok{  }\KeywordTok{geom\_line}\NormalTok{() }\OperatorTok{+}
\StringTok{  }\KeywordTok{xlab}\NormalTok{(}\StringTok{"Distance (m)"}\NormalTok{) }\OperatorTok{+}
...
\NormalTok{jim\_profile <{-}}\StringTok{ }\NormalTok{shorts}\OperatorTok{::}\KeywordTok{model\_using\_radar}\NormalTok{(}
  \DataTypeTok{time =}\NormalTok{ jim\_data}\OperatorTok{$}\NormalTok{time,}
  \DataTypeTok{velocity =}\NormalTok{ jim\_data}\OperatorTok{$}\NormalTok{velocity}
\NormalTok{)}

\CommentTok{\# Parameters}
\KeywordTok{unlist}\NormalTok{(jim\_profile}\OperatorTok{$}\NormalTok{parameters)}
\CommentTok{\#>        MSS        TAU        MAC       PMAX }
\CommentTok{\#>  7.9979331  0.8886595  8.9999977 17.9953449}

\CommentTok{\# Model performance/fit}
\KeywordTok{unlist}\NormalTok{(jim\_profile}\OperatorTok{$}\NormalTok{model\_fit)}
\CommentTok{\#>         RSE   R\_squared      minErr      maxErr        RMSE }
\CommentTok{\#>  0.05058726  0.99924408 {-}0.15099212  0.16415830  0.05050288}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{ggplot}\NormalTok{(jim\_profile}\OperatorTok{$}\NormalTok{data, }\KeywordTok{aes}\NormalTok{(}\DataTypeTok{x =}\NormalTok{ time)) }\OperatorTok{+}
\StringTok{  }\KeywordTok{theme\_bw}\NormalTok{() }\OperatorTok{+}
\StringTok{  }\KeywordTok{geom\_line}\NormalTok{(}\KeywordTok{aes}\NormalTok{(}\DataTypeTok{y =}\NormalTok{ velocity), }\DataTypeTok{alpha =} \FloatTok{0.5}\NormalTok{) }\OperatorTok{+}
\StringTok{  }\KeywordTok{geom\_line}\NormalTok{(}\KeywordTok{aes}\NormalTok{(}\DataTypeTok{y =}\NormalTok{ pred\_velocity), }\DataTypeTok{color =} \StringTok{"red"}\NormalTok{, }\DataTypeTok{alpha =} \FloatTok{0.5}\NormalTok{) }\OperatorTok{+}
\StringTok{  }\KeywordTok{xlab}\NormalTok{(}\StringTok{"Time (s)"}\NormalTok{) }\OperatorTok{+}
\StringTok{  }\KeywordTok{ylab}\NormalTok{(}\StringTok{"Velocity (m/s)"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{mixed\_model <{-}}\StringTok{ }\NormalTok{shorts}\OperatorTok{::}\KeywordTok{mixed\_model\_using\_radar}\NormalTok{(}
  \DataTypeTok{data =}\NormalTok{ radar\_gun\_data,}
  \DataTypeTok{time =} \StringTok{"time"}\NormalTok{,}
  \DataTypeTok{velocity =} \StringTok{"velocity"}\NormalTok{,}
  \DataTypeTok{athlete =} \StringTok{"athlete"}
\NormalTok{)}
...
\CommentTok{\#> $fixed}
\CommentTok{\#>        MSS      TAU     MAC     PMAX}
\CommentTok{\#> 1 8.301178 1.007782 8.23708 17.09437}
\CommentTok{\#> }
\CommentTok{\#> $random}
\CommentTok{\#>     athlete      MSS       TAU      MAC     PMAX}
...
\NormalTok{mixed\_model}\OperatorTok{$}\NormalTok{model\_fit}
\CommentTok{\#> $RSE}
\CommentTok{\#> [1] 0.05164818}
\CommentTok{\#> }
\CommentTok{\#> $R\_squared}
\CommentTok{\#> [1] 0.9994217}
\CommentTok{\#> }
\CommentTok{\#> $minErr}
\CommentTok{\#> [1] {-}0.2191295}
\CommentTok{\#> }
\CommentTok{\#> $maxErr}
\CommentTok{\#> [1] 0.198329}
\CommentTok{\#> }
\CommentTok{\#> $RMSE}
\CommentTok{\#> [1] 0.05156203}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{acceleration\_over\_time <{-}}\StringTok{ }\KeywordTok{merge}\NormalTok{(}
\NormalTok{    mixed\_model}\OperatorTok{$}\NormalTok{parameters}\OperatorTok{$}\NormalTok{random,}
    \KeywordTok{data.frame}\NormalTok{(}\DataTypeTok{time =} \KeywordTok{seq}\NormalTok{(}\DecValTok{0}\NormalTok{, }\DecValTok{6}\NormalTok{, }\DataTypeTok{length.out =} \DecValTok{100}\NormalTok{))}
\NormalTok{)}

\NormalTok{acceleration\_over\_time}\OperatorTok{$}\NormalTok{pred\_acceleration <{-}}\StringTok{ }\KeywordTok{with}\NormalTok{(acceleration\_over\_time,}
\NormalTok{  shorts}\OperatorTok{::}\KeywordTok{predict\_acceleration\_at\_time}\NormalTok{(}
    \DataTypeTok{time =}\NormalTok{ time,}
    \DataTypeTok{MSS =}\NormalTok{ MSS,}
    \DataTypeTok{TAU =}\NormalTok{ TAU)}
\NormalTok{)}

\KeywordTok{ggplot}\NormalTok{(acceleration\_over\_time, }\KeywordTok{aes}\NormalTok{(}\DataTypeTok{x =}\NormalTok{ time, }\DataTypeTok{y =}\NormalTok{ pred\_acceleration, }\DataTypeTok{color =}\NormalTok{ athlete)) }\OperatorTok{+}
\StringTok{  }\KeywordTok{theme\_bw}\NormalTok{() }\OperatorTok{+}
\StringTok{  }\KeywordTok{geom\_line}\NormalTok{() }\OperatorTok{+}
\StringTok{  }\KeywordTok{xlab}\NormalTok{(}\StringTok{"Time (s)"}\NormalTok{) }\OperatorTok{+}
...
Here I will provide quick summary. Often, this bias in estimates is dealt with by using heuristic rule of thumb of adding \texttt{time\_correction} to split times (e.g.~from 0.3-0.5sec; see more in Haugen, Tønnessen, and Seiler (\protect\hyperlink{ref-haugenDifferenceStartImpact2012}{2012})). This functionality is available in all covered \texttt{shorts} functions:

\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{mixed\_model\_corrected <{-}}\StringTok{ }\NormalTok{shorts}\OperatorTok{::}\KeywordTok{mixed\_model\_using\_splits}\NormalTok{(}
  \DataTypeTok{data =}\NormalTok{ split\_times,}
  \DataTypeTok{distance =} \StringTok{"distance"}\NormalTok{,}
  \DataTypeTok{time =} \StringTok{"time"}\NormalTok{,}
  \DataTypeTok{athlete =} \StringTok{"athlete"}\NormalTok{, }
  \DataTypeTok{time\_correction =} \FloatTok{0.3}
\NormalTok{)}
...
\KeywordTok{unlist}\NormalTok{(mixed\_model}\OperatorTok{$}\NormalTok{model\_fit)}
\CommentTok{\#>         RSE   R\_squared      minErr      maxErr        RMSE }
\CommentTok{\#>  0.05164818  0.99942171 {-}0.21912952  0.19832897  0.05156203}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{velocity\_over\_distance\_corrected <{-}}\StringTok{ }\KeywordTok{merge}\NormalTok{(}
\NormalTok{    mixed\_model\_corrected}\OperatorTok{$}\NormalTok{parameters}\OperatorTok{$}\NormalTok{random,}
    \KeywordTok{data.frame}\NormalTok{(}\DataTypeTok{distance =} \KeywordTok{seq}\NormalTok{(}\DecValTok{0}\NormalTok{, }\DecValTok{40}\NormalTok{, }\DataTypeTok{length.out =} \DecValTok{1000}\NormalTok{))}
\NormalTok{)}
...
\KeywordTok{ggplot}\NormalTok{(velocity\_over\_distance\_corrected, }\KeywordTok{aes}\NormalTok{(}\DataTypeTok{x =}\NormalTok{ distance, }\DataTypeTok{y =}\NormalTok{ pred\_velocity, }\DataTypeTok{color =}\NormalTok{ athlete)) }\OperatorTok{+}
\StringTok{  }\KeywordTok{theme\_bw}\NormalTok{() }\OperatorTok{+}
\StringTok{  }\KeywordTok{geom\_line}\NormalTok{() }\OperatorTok{+}
\StringTok{  }\KeywordTok{xlab}\NormalTok{(}\StringTok{"Distance (m)"}\NormalTok{) }\OperatorTok{+}
\StringTok{  }\KeywordTok{ylab}\NormalTok{(}\StringTok{"Predicted velocity (m/s)"}\NormalTok{)}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{kimberley\_profile\_with\_time\_correction <{-}}\StringTok{ }\NormalTok{shorts}\OperatorTok{::}\KeywordTok{model\_using\_splits\_with\_time\_correction}\NormalTok{(}
  \DataTypeTok{distance =}\NormalTok{ kimberley\_data}\OperatorTok{$}\NormalTok{distance,}
  \DataTypeTok{time =}\NormalTok{ kimberley\_data}\OperatorTok{$}\NormalTok{time)  }

\CommentTok{\# Parameters}
\KeywordTok{unlist}\NormalTok{(kimberley\_profile\_with\_time\_correction}\OperatorTok{$}\NormalTok{parameters)}
\CommentTok{\#>             MSS             TAU             MAC            PMAX time\_correction }
\CommentTok{\#>       8.9748353       1.2348565       7.2679175      16.3070907       0.2346537}

\CommentTok{\# Model performance/fit}
\KeywordTok{unlist}\NormalTok{(kimberley\_profile\_with\_time\_correction}\OperatorTok{$}\NormalTok{model\_fit)}
\CommentTok{\#>           RSE     R\_squared        minErr        maxErr          RMSE }
\CommentTok{\#>  0.0011290466  0.9999996942 {-}0.0012094658  0.0011807342  0.0007983565}


\CommentTok{\# Mixed{-}effect model using \textasciigrave{}time\_correction\textasciigrave{} as fixed effect only}
\CommentTok{\# To use \textasciigrave{}time\_correction\textasciigrave{} as random effects, use corrections\_as\_random\_effects = TRUE}
\NormalTok{mixed\_model\_with\_time\_correction <{-}}\StringTok{ }\NormalTok{shorts}\OperatorTok{::}\KeywordTok{mixed\_model\_using\_splits\_with\_time\_correction}\NormalTok{(}
  \DataTypeTok{data =}\NormalTok{ split\_times,}
  \DataTypeTok{distance =} \StringTok{"distance"}\NormalTok{,}
  \DataTypeTok{time =} \StringTok{"time"}\NormalTok{,}
  \DataTypeTok{athlete =} \StringTok{"athlete"}\NormalTok{,}
  \DataTypeTok{corrections\_as\_random\_effects =} \OtherTok{FALSE}
\NormalTok{)}

\CommentTok{\# Parameters}
\NormalTok{mixed\_model\_with\_time\_correction}\OperatorTok{$}\NormalTok{parameters}
\CommentTok{\#> $fixed}
\CommentTok{\#>        MSS       TAU time\_correction     MAC     PMAX}
\CommentTok{\#> 1 8.304014 0.9687348       0.1989677 8.57202 17.79554}
\CommentTok{\#> }
\CommentTok{\#> $random}
\CommentTok{\#>     athlete       MSS       TAU time\_correction       MAC     PMAX}
\CommentTok{\#> 1     James 10.186327 1.2429367       0.1989677  8.195370 20.87018}
\CommentTok{\#> 2       Jim  7.946099 0.7643674       0.1989677 10.395655 20.65123}
\CommentTok{\#> 3      John  7.996262 1.0488272       0.1989677  7.624003 15.24088}
\CommentTok{\#> 4 Kimberley  8.899472 1.1615147       0.1989677  7.661953 17.04683}
\CommentTok{\#> 5  Samantha  6.491911 0.6260282       0.1989677 10.369998 16.83028}

\CommentTok{\# Model performance/fit}
\KeywordTok{unlist}\NormalTok{(mixed\_model\_with\_time\_correction}\OperatorTok{$}\NormalTok{model\_fit)}
\CommentTok{\#>          RSE    R\_squared       minErr       maxErr         RMSE }
\CommentTok{\#>  0.005976815  0.999990286 {-}0.016508275  0.009370607  0.004882226}
\end{Highlighting}
\end{Shaded}
...
\CommentTok{\# Make a LV profile}
\CommentTok{\# Here we have used \textasciigrave{}with\textasciigrave{} command to simplify the code}
\CommentTok{\# If not we need to use:}
\CommentTok{\#}
\CommentTok{\# vjsim::make\_load\_profile(}
\CommentTok{\#   bodyweight = jack\_data$bodyweight,}
\CommentTok{\#   external\_load = jack\_data$external\_load,}
\CommentTok{\#   aerial\_time = jack\_data$aerial\_time,}
\CommentTok{\#   plot = TRUE}
\CommentTok{\# )}

\NormalTok{jack\_LV\_profile <{-}}\StringTok{ }\KeywordTok{with}\NormalTok{(jack\_data,}
\NormalTok{ vjsim}\OperatorTok{::}\KeywordTok{make\_load\_profile}\NormalTok{(}
...
\NormalTok{  profile <{-}}\StringTok{ }\KeywordTok{with}\NormalTok{(}
\NormalTok{    data,}
\NormalTok{    vjsim}\OperatorTok{::}\KeywordTok{make\_samozino\_profile}\NormalTok{(}
      \DataTypeTok{bodyweight =}\NormalTok{ bodyweight,}
      \DataTypeTok{push\_off\_distance =}\NormalTok{ push\_off\_distance,}
...
\NormalTok{  )}
  ...
  \KeywordTok{return}\NormalTok{(}\KeywordTok{data.frame}\NormalTok{(}
    \DataTypeTok{F0 =}\NormalTok{ profile}\OperatorTok{$}\NormalTok{F0,}
    \DataTypeTok{V0 =}\NormalTok{ profile}\OperatorTok{$}\NormalTok{V0,}
    \DataTypeTok{height =}\NormalTok{ profile}\OperatorTok{$}\NormalTok{height,}
    \DataTypeTok{optimal\_F0 =}\NormalTok{ profile}\OperatorTok{$}\NormalTok{optimal\_F0,}
    \DataTypeTok{optimal\_V0 =}\NormalTok{ profile}\OperatorTok{$}\NormalTok{optimal\_V0,}
    \DataTypeTok{optimal\_height =}\NormalTok{ profile}\OperatorTok{$}\NormalTok{optimal\_height,}
    \DataTypeTok{Sfv\_perc =}\NormalTok{ profile}\OperatorTok{$}\NormalTok{Sfv\_perc}
\NormalTok{  ))}
\NormalTok{\}}
\end{Highlighting}
\end{Shaded}
